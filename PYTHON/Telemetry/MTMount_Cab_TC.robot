...
Read Subscriber
    ...
    Should Contain X Times    ${list}    Cabinet_Internal_Temperature_1 = 1.0    10
    Should Contain X Times    ${list}    Cabinet_Internal_Temperature_2 = 1.0    10
    Should Contain X Times    ${list}    Cabinet_External_Temperature_1 = 1.0    10
    Should Contain X Times    ${list}    Cabinet_External_Temperature_2 = 1.0    10
