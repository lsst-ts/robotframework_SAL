*** Settings ***
Documentation    M2MS_MirrorPositionMeasured communications tests.
Force Tags    python
...
*** Variables ***
${subSystem}    m2ms
${component}    MirrorPositionMeasured
${timeout}    30s
...
Read Subscriber
    ...
    Should Contain X Times    ${list}    xTilt = 1.0    10
    Should Contain X Times    ${list}    yTilt = 1.0    10
    Should Contain X Times    ${list}    piston = 1.0    10
    Should Contain X Times    ${list}    xPosition = 1.0    10
    Should Contain X Times    ${list}    yPosition = 1.0    10
    Should Contain X Times    ${list}    theta_z_position = 1.0    10
