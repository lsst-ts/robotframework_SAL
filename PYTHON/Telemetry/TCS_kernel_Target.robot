...
Read Subscriber
    ...
    Should Contain X Times    ${list}    XOffset = 1.0    10
    Should Contain X Times    ${list}    YOffset = 1.0    10
    Should Contain X Times    ${list}    az = 1.0    10
    Should Contain X Times    ${list}    azdot = 1.0    10
    Should Contain X Times    ${list}    el = 1.0    10
    Should Contain X Times    ${list}    eldot = 1.0    10
    Should Contain X Times    ${list}    focalplaneX = 1.0    10
    Should Contain X Times    ${list}    focalplaneY = 1.0    10
