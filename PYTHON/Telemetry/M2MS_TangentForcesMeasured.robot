...
Read Subscriber
    ...
    Should Contain X Times    ${list}    tangentLink_0deg_forceMeasured = 1.0    10
    Should Contain X Times    ${list}    tangentLink_60deg_forceMeasured = 1.0    10
    Should Contain X Times    ${list}    tangentLink_120deg_forceMeasured = 1.0    10
    Should Contain X Times    ${list}    tangentLink_180deg_forceMeasured = 1.0    10
    Should Contain X Times    ${list}    tangentLink_240deg_forceMeasured = 1.0    10
    Should Contain X Times    ${list}    tangentLink_300deg_forceMeasured = 1.0    10
