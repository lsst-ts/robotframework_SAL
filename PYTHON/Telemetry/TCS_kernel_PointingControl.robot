*** Settings ***
Documentation    TCS_kernel_PointingControl communications tests.
...
*** Variables ***
${subSystem}    tcs
${component}    kernel_PointingControl
${timeout}    30s
...
Read Subscriber
    ...
    Should Contain X Times    ${list}    AGuide = 1.0    10
    Should Contain X Times    ${list}    ALocal = 1.0    10
    Should Contain X Times    ${list}    BGuide = 1.0    10
    Should Contain X Times    ${list}    BLocal = 1.0    10
