...
Read Subscriber
    ...
    Should Contain X Times    ${list}    pairNumber = 1    10
    Should Contain X Times    ${list}    proposalId = 1    10
    Should Contain X Times    ${list}    subSequenceNumber = 1    10
    Should Contain X Times    ${list}    targetId = 1    10
    Should Contain X Times    ${list}    targetProposalRankValue = 1.0    10
    Should Contain X Times    ${list}    targetRankPosition = 1    10
