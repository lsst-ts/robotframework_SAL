*** Settings ***
Documentation    DM_raft_images_sent_current communications tests.
...
*** Variables ***
${subSystem}    dm
${component}    raft_images_sent_current
${timeout}    30s
...
Read Subscriber
    ...
    Should Contain X Times    ${list}    current_mode_image_count = 1    10
    Should Contain X Times    ${list}    operations_image_count = 1    10
