...
Read Subscriber
    ...
    Should Contain X Times    ${list}    azCalibrated(4) = [0.0, 1.0, 2.0, 3.0]    10
    Should Contain X Times    ${list}    azEncoder(4) = [0, 1, 2, 3]    10
    Should Contain X Times    ${list}    elevCalibrated(4) = [0.0, 1.0, 2.0, 3.0]    10
    Should Contain X Times    ${list}    elevEncoder(4) = [0, 1, 2, 3]    10
    Should Contain X Times    ${list}    screenEncoder(4) = [0, 1, 2, 3]    10
    Should Contain X Times    ${list}    shutterL(4) = [0, 1, 2, 3]    10
    Should Contain X Times    ${list}    shutterR(4) = [0, 1, 2, 3]    10
