...
Read Subscriber
    ...
    Should Contain X Times    ${list}    AngularVelocityX = 1.0    10
    Should Contain X Times    ${list}    AngularVelocityY = 1.0    10
    Should Contain X Times    ${list}    AngularVelocityZ = 1.0    10
    Should Contain X Times    ${list}    SequenceNumber = 1    10
    Should Contain X Times    ${list}    Temperature = 1    10
