*** Settings ***
Documentation    TCS_kernel_FK5Target communications tests.
Force Tags    python
...
Read Subscriber
    ...
    Should Contain X Times    ${list}    pmDec = 1.0    10
    Should Contain X Times    ${list}    pmRA = 1.0    10
    Should Contain X Times    ${list}    ra = 1.0    10
    Should Contain X Times    ${list}    rv = 1.0    10
