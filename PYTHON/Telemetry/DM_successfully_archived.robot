*** Settings ***
Documentation    DM_successfully_archived communications tests.
...
*** Variables ***
${subSystem}    dm
${component}    successfully_archived
${timeout}    30s
...
Read Subscriber
    ...
    Should Contain X Times    ${list}    focal_plane_current_image_count = 1    10
    Should Contain X Times    ${list}    focal_plane_operations_image_count = 1    10
    Should Contain X Times    ${list}    last_focal_plane_image_id = 1    10
