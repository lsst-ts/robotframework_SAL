...
Read Subscriber
    ...
    Should Contain X Times    ${list}    alerts_sent = 1    10
    Should Contain X Times    ${list}    available_workers = 1    10
    Should Contain X Times    ${list}    latency_readout_to_last_alert = 1    10
