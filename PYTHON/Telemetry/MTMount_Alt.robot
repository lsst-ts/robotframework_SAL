...
Read Subscriber
    ...
    Should Contain X Times    ${list}    Positive_Operational_Directional_Limit_Switch = 1    10
    Should Contain X Times    ${list}    Negative_Operational_Directional_Limit_Switch = 1    10
