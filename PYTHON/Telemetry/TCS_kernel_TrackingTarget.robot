...
Read Subscriber
    ...
    Should Contain X Times    ${list}    PositionX = 1.0    10
    Should Contain X Times    ${list}    PositionY = 1.0    10
    Should Contain X Times    ${list}    T0 = 1.0    10
    Should Contain X Times    ${list}    VelocityX = 1.0    10
    Should Contain X Times    ${list}    VelocityY = 1.0    10
