...
Read Subscriber
    ...
    Should Contain X Times    ${list}    tangentLink_0deg_strainsMeasured(4) = [0.0, 1.0, 2.0, 3.0]    10
    Should Contain X Times    ${list}    tangentLink_60deg_strainsMeasured(4) = [0.0, 1.0, 2.0, 3.0]    10
    Should Contain X Times    ${list}    tangentLink_120deg_strainsMeasured(4) = [0.0, 1.0, 2.0, 3.0]    10
    Should Contain X Times    ${list}    tangentLink_180deg_strainsMeasured(4) = [0.0, 1.0, 2.0, 3.0]    10
    Should Contain X Times    ${list}    tangentLink_240deg_strainsMeasured(4) = [0.0, 1.0, 2.0, 3.0]    10
    Should Contain X Times    ${list}    tangentLink_300deg_strainsMeasured(4) = [0.0, 1.0, 2.0, 3.0]    10
