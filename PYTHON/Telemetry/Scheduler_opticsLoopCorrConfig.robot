...
Read Subscriber
    ...
    Should Contain X Times    ${list}    tel_optics_ol_slope = 1.0    10
    Should Contain X Times    ${list}    tel_optics_cl_alt_limit(3) = [0.0, 1.0, 2.0]    10
    Should Contain X Times    ${list}    tel_optics_cl_delay(2) = [0.0, 1.0]    10
