...
Read Subscriber
    ...
    Should Contain X Times    ${list}    PowerNetworkACurrent = 1.0    10
    Should Contain X Times    ${list}    PowerNetworkBCurrent = 1.0    10
    Should Contain X Times    ${list}    PowerNetworkCCurrent = 1.0    10
    Should Contain X Times    ${list}    PowerNetworkDCurrent = 1.0    10
    Should Contain X Times    ${list}    LightPowerNetworkCurrent = 1.0    10
    Should Contain X Times    ${list}    ControlsPowerNetworkCurrent = 1.0    10
