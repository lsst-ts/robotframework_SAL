*** Settings ***
Documentation    MTMount_Alt_TC communications tests.
...
Read Subscriber
    ...
    Should Contain X Times    ${list}    Drive_Surface_Temperature_1 = 1.0    10
    Should Contain X Times    ${list}    Drive_Surface_Temperature_2 = 1.0    10
    Should Contain X Times    ${list}    Motor_Surface_Temperature_1 = 1.0    10
    Should Contain X Times    ${list}    Motor_Surface_Temperature_2 = 1.0    10
