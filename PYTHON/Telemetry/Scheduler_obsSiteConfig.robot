...
Read Subscriber
    ...
    Should Contain X Times    ${list}    latitude = 1.0    10
    Should Contain X Times    ${list}    longitude = 1.0    10
    Should Contain X Times    ${list}    height = 1.0    10
    Should Contain X Times    ${list}    pressure = 1.0    10
    Should Contain X Times    ${list}    temperature = 1.0    10
    Should Contain X Times    ${list}    relative_humidity = 1.0    10
