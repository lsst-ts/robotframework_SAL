...
Start Sender - Verify Missing Inputs Error
    ...
    Log    ${output}
    Should Contain    ${output}   ERROR : Invalid or missing arguments : inputTemperature outputTemperature flowRate priority
...
Start Sender
    ...
    Write    cd ${SALWorkDir}/${subSystem}/python
    Comment    Start Sender.
    ${input}=    Write    python ${subSystem}_Event_${component}.py 0.00913719608418 0.12479731473 0.714540675547 1743213151
    ${output}=    Read Until Prompt
    Log    ${output}
