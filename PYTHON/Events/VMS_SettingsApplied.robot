...
Start Sender
    ...
    Write    cd ${SALWorkDir}/${subSystem}/python
    Comment    Start Sender.
    ${input}=    Write    python ${subSystem}_Event_${component}.py 86.0141  1691919550
    ${output}=    Read Until Prompt
    Log    ${output}
