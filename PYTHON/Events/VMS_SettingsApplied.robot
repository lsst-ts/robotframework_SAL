...
Start Sender
    ...
    Write    cd ${SALWorkDir}/${subSystem}/python
    Comment    Start Sender.
    ${input}=    Write    python ${subSystem}_Event_${component}.py 34.9737  -771759775
    ${output}=    Read Until Prompt
    Log    ${output}
