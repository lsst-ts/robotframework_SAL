...
Start Sender
    ...
    Write    cd ${SALWorkDir}/${subSystem}/python
    Comment    Start Sender.
    ${input}=    Write    python ${subSystem}_Event_${component}.py 18.0687  -1025647806
    ${output}=    Read Until Prompt
    Log    ${output}
