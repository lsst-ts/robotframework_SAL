...
Start Sender
    ...
    Write    cd ${SALWorkDir}/${subSystem}/python
    Comment    Start Sender.
    ${input}=    Write    python ${subSystem}_Event_${component}.py 82.1422  -286110311
    ${output}=    Read Until Prompt
    Log    ${output}
