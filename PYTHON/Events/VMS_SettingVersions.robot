...
Start Sender
    ...
    Write    cd ${SALWorkDir}/${subSystem}/python
    Comment    Start Sender.
    ${input}=    Write    python ${subSystem}_Event_${component}.py 85.2393  -1849198646
    ${output}=    Read Until Prompt
    Log    ${output}
