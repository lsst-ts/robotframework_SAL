...
Start Sender
    ...
    Write    cd ${SALWorkDir}/${subSystem}/python
    Comment    Start Sender.
    ${input}=    Write    python ${subSystem}_Event_${component}.py  704646745 1947117739
    ${output}=    Read Until Prompt
    Log    ${output}
