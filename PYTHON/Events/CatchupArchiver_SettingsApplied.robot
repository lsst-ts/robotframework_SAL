...
Start Sender
    ...
    Write    cd ${SALWorkDir}/${subSystem}/python
    Comment    Start Sender.
    ${input}=    Write    python ${subSystem}_Event_${component}.py  -1928634819 -171838547
    ${output}=    Read Until Prompt
    Log    ${output}
