...
Start Sender
    ...
    Write    cd ${SALWorkDir}/${subSystem}/python
    Comment    Start Sender.
    ${input}=    Write    python ${subSystem}_Event_${component}.py  1982737779 -1304525531
    ${output}=    Read Until Prompt
    Log    ${output}
