...
Start Sender
    ...
    Write    cd ${SALWorkDir}/${subSystem}/python
    Comment    Start Sender.
    ${input}=    Write    python ${subSystem}_Event_${component}.py TErUDAnZNkNmMzjiVEVWDOKjzyngkKeBDAIDAcnFwDCabhmMTJjOMxNPuCXKpUdiYYwfWnFSBFKZfBVkmxSysWJIYpLKpMdar -184876176
    ${output}=    Read Until Prompt
    Log    ${output}
