...
Start Sender
    ...
    Write    cd ${SALWorkDir}/${subSystem}/python
    Comment    Start Sender.
    ${input}=    Write    python ${subSystem}_Event_${component}.py qByTHoSEdMRugPhmXHjTKxEvldtKTnlnUROBaOrvVLcapfoXvFpmdgzRAsZMByKBuXAlIXmfCajsbaPCzKhdNADrpKSzNzWWhCCcZuyaQlJPCMXpBeAomVunIVPrFXDp 57.2073  1128866093 801891938
    ${output}=    Read Until Prompt
    Log    ${output}
