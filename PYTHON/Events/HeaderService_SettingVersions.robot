*** Settings ***
Documentation    HeaderService_SettingVersions communications tests.
Force Tags    python    
...
Start Sender
    ...
    Write    cd ${SALWorkDir}/${subSystem}/python
    Comment    Start Sender.
    ${input}=    Write    python ${subSystem}_Event_${component}.py 5.5644 FSQYWOhcpKznkKrTMFqVynxmeIxsazvN 2065758482
    ${output}=    Read Until Prompt
    Log    ${output}
