...
Start Sender - Verify Missing Inputs Error
    ...
    Log    ${output}
    Should Contain    ${output}   ERROR : Invalid or missing arguments : IP portRange readTimeout writeTimeout connectionTimeout priority
...
Start Sender
    ...
    Write    cd ${SALWorkDir}/${subSystem}/python
    Comment    Start Sender.
    ${input}=    Write    python ${subSystem}_Event_${component}.py CXegXMrVkeOFZyL -453989292 0.366631947815 0.762873595538 0.0445908809314 -1888909267
    ${output}=    Read Until Prompt
    Log    ${output}
