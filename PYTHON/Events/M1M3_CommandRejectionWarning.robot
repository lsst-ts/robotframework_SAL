...
Start Sender
    ...
    Write    cd ${SALWorkDir}/${subSystem}/python
    Comment    Start Sender.
    ${input}=    Write    python ${subSystem}_Event_${component}.py 85.2674 BpwHbKxAVgwmJotbskvwPsKdDEplzUjOknVcVEVUKVjAQUlvFBLzwQUuzutBMHbI BbVCSpZIPOvDOhmeWIlcryVKNpBPibugwwZIolrdQyddAvyKloslEwsfqyBrgpNGoeajsbTYpoBVryRpYpWoiuZQqYNvRRuCneDdJZELdnCzoHGWIIYziFyngbeDltMq 1917625293
    ${output}=    Read Until Prompt
    Log    ${output}
