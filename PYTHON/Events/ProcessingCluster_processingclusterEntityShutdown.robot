...
Start Sender
    ...
    Write    cd ${SALWorkDir}/${subSystem}/python
    Comment    Start Sender.
    ${input}=    Write    python ${subSystem}_Event_${component}.py ewCzpLrKCYMyLbJLLhjKOwJbiMbpSubfdlANdVGAyFzZgUkDnGyhIPAGZneYnJfEGPynacOoQpWfwWoNrtSvXmdpPOkKEpuGsiPrxXPldeCIdGsVEntzfzWFkHHDYBHX 74.9447  1005319080 505772441
    ${output}=    Read Until Prompt
    Log    ${output}
