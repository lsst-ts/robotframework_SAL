...
Start Sender
    ...
    Write    cd ${SALWorkDir}/${subSystem}/python
    Comment    Start Sender.
    ${input}=    Write    python ${subSystem}_Event_${component}.py MYsRVkFcNzbsdyfzWHsClZmqHWyynxrxfbRgIuCrAokNQHkPXwhElstXrFYtFGvOgFoXYcWPhLDKHyAKHLmrMMOaNYkIcETzCFNnplJwnCshUHPIedbiHmVtYtKjSJYj 405313524
    ${output}=    Read Until Prompt
    Log    ${output}
