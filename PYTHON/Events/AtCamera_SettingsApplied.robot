...
Start Sender
    ...
    Write    cd ${SALWorkDir}/${subSystem}/python
    Comment    Start Sender.
    ${input}=    Write    python ${subSystem}_Event_${component}.py  290966421 -553456249
    ${output}=    Read Until Prompt
    Log    ${output}
