...
Start Commander - Verify Timeout without Controller
    ...
    Write    cd ${SALWorkDir}/${subSystem}/python
    Comment    Start Commander.
    ${input}=    Write    python ${subSystem}_Commander_${component}.py 2138719707 88.5503 0 0 1 1 J
    ${output}=    Read Until Prompt
    Log    ${output}
...
Start Commander
    ...
    Should Contain X Times    ${output}    numImages : 2138719707    1
    Should Contain X Times    ${output}    expTime : 88.5503    1
    ...
    Should Contain X Times    ${output}    imageSequenceName : J    1
    ${CmdComplete}=    Get Line    ${output}    -2
