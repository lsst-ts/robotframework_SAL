...
Start Commander - Verify Timeout without Controller
    ...
    Write    cd ${SALWorkDir}/${subSystem}/python
    Comment    Start Commander.
    ${input}=    Write    python ${subSystem}_Commander_${component}.py 46.349 8.6303
    ${output}=    Read Until Prompt
    Log    ${output}
...
Start Commander
    ...
    Should Contain X Times    ${output}    amin : 46.349    1
    Should Contain X Times    ${output}    amax : 8.6303    1
    ${CmdComplete}=    Get Line    ${output}    -2
