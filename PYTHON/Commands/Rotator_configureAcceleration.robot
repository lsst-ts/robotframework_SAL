...
Start Commander - Verify Timeout without Controller
    ...
    Write    cd ${SALWorkDir}/${subSystem}/python
    Comment    Start Commander.
    ${input}=    Write    python ${subSystem}_Commander_${component}.py 24.5115 84.3991
    ${output}=    Read Until Prompt
    Log    ${output}
...
Start Commander
    ...
    Should Contain X Times    ${output}    amin : 24.5115    1
    Should Contain X Times    ${output}    amax : 84.3991    1
    ${CmdComplete}=    Get Line    ${output}    -2
