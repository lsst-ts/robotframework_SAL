...
Verify Dome C++ Command Interfaces
    [Documentation]    Verify the C++ interfaces were properly created.
    [Tags]
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_command_CloseShutter_commander
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_command_CloseShutter_controller
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_command_Crawl_commander
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_command_Crawl_controller
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_command_Louvers_commander
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_command_Louvers_controller
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_command_Move_commander
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_command_Move_controller
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_command_MovetoCal_commander
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_command_MovetoCal_controller
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_command_OpenShutter_commander
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_command_OpenShutter_controller
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_command_Park_commander
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_command_Park_controller
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_command_Track_commander
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_command_Track_controller

Verify Dome C++ Event Interfaces
    [Documentation]    Verify the C++ interfaces were properly created.
    [Tags]
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_logevent_AccLimit_send
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_logevent_AccLimit_log
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_logevent_VelLimit_send
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_logevent_VelLimit_log
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_logevent_crawlLost_send
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_logevent_crawlLost_log
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_logevent_crawling_send
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_logevent_crawling_log
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_logevent_interlock_send
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_logevent_interlock_log
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_logevent_jerkLimit_send
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_logevent_jerkLimit_log
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_logevent_lldvError_send
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_logevent_lldvError_log
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_logevent_lldvOK_send
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_logevent_lldvOK_log
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_logevent_posLimit_send
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_logevent_posLimit_log
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_logevent_powerError_send
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_logevent_powerError_log
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_logevent_screenLimit_send
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_logevent_screenLimit_log
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_logevent_slewError_send
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_logevent_slewError_log
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_logevent_slewOK_send
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_logevent_slewOK_log
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_logevent_slewReady_send
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_logevent_slewReady_log
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_logevent_tempError_send
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_logevent_tempError_log
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_logevent_trackLost_send
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_logevent_trackLost_log
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_logevent_tracking_send
    File Should Exist    ${SALWorkDir}/dome/cpp/src/sacpp_dome_logevent_tracking_log
...
Verify Dome Python Command Interfaces
    ...
    @{files}=    List Directory    ${SALWorkDir}/dome/python    pattern=*dome*
    Log Many    @{files}
    File Should Exist    ${SALWorkDir}/dome/python/dome_command_CloseShutter_Commander.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_command_CloseShutter_Controller.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_command_Crawl_Commander.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_command_Crawl_Controller.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_command_Louvers_Commander.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_command_Louvers_Controller.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_command_Move_Commander.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_command_Move_Controller.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_command_MovetoCal_Commander.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_command_MovetoCal_Controller.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_command_OpenShutter_Commander.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_command_OpenShutter_Controller.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_command_Park_Commander.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_command_Park_Controller.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_command_Track_Commander.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_command_Track_Controller.py
...
Verify Dome Python Event Interfaces
    ...
    @{files}=    List Directory    ${SALWorkDir}/dome/python    pattern=*dome*
    Log Many    @{files}
    File Should Exist    ${SALWorkDir}/dome/python/dome_logevent_AccLimit_Event.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_logevent_AccLimit_EventLogger.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_logevent_VelLimit_Event.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_logevent_VelLimit_EventLogger.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_logevent_crawlLost_Event.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_logevent_crawlLost_EventLogger.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_logevent_crawling_Event.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_logevent_crawling_EventLogger.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_logevent_interlock_Event.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_logevent_interlock_EventLogger.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_logevent_jerkLimit_Event.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_logevent_jerkLimit_EventLogger.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_logevent_lldvError_Event.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_logevent_lldvError_EventLogger.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_logevent_lldvOK_Event.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_logevent_lldvOK_EventLogger.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_logevent_posLimit_Event.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_logevent_posLimit_EventLogger.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_logevent_powerError_Event.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_logevent_powerError_EventLogger.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_logevent_screenLimit_Event.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_logevent_screenLimit_EventLogger.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_logevent_slewError_Event.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_logevent_slewError_EventLogger.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_logevent_slewOK_Event.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_logevent_slewOK_EventLogger.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_logevent_slewReady_Event.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_logevent_slewReady_EventLogger.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_logevent_tempError_Event.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_logevent_tempError_EventLogger.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_logevent_trackLost_Event.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_logevent_trackLost_EventLogger.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_logevent_tracking_Event.py
    File Should Exist    ${SALWorkDir}/dome/python/dome_logevent_tracking_EventLogger.py
