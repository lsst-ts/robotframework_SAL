...
Start Sender
    ...
    Write    cd ${SALWorkDir}/${subSystem}/cpp/src
    Comment    Start Sender.
    ${input}=    Write    ./sacpp_${subSystem}_${component}_send test 2130764217 60.4537 test test 1898623095 test 250252926
    ${output}=    Read Until Prompt
    Log    ${output}
