...
Start Sender
    ...
    Write    cd ${SALWorkDir}/${subSystem}/cpp/src
    Comment    Start Sender.
    ${input}=    Write    ./sacpp_${subSystem}_${component}_send 255730655 969021797
    ${output}=    Read Until Prompt
    Log    ${output}
...
Read Logger
    [Tags]    functional
    Switch Connection    Logger
    ${output}=    Read Until    priority : 969021797
    Log    ${output}
    Should Contain X Times    ${output}    === Event dmToArchive received =     1
    Should Contain    ${output}    image_id : 255730655
    Should Contain    ${output}    priority : 969021797
