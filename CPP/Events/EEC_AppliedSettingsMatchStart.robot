...
Start Sender
    ...
    Write    cd ${SALWorkDir}/${subSystem}/cpp/src
    Comment    Start Sender.
    ${input}=    Write    ./sacpp_${subSystem}_${component}_send 0 46.9916 -938700773
    ${output}=    Read Until Prompt
    Log    ${output}
...
Read Logger
    [Tags]    functional
    Switch Connection    Logger
    ${output}=    Read Until    priority : -938700773
    Log    ${output}
    ...
    Should Contain    ${output}    timestamp : 46.9916
    Should Contain    ${output}    priority : -938700773
