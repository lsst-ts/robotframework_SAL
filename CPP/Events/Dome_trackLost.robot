*** Settings ***
Documentation    Dome_trackLost sender/logger tests.
...
Start Sender
    ...
    Write    cd ${SALWorkDir}/${subSystem}/cpp/src
    Comment    Start Sender.
    ${input}=    Write    ./sacpp_${subSystem}_${component}_send 10274    #|tee ${comOut}
    ${output}=    Read Until Prompt
    Log    ${output}
    Should Contain X Times    ${output}    === [putSample] dome::logevent_trackLost writing a message containing :    1
...
Read Logger
    ...
    Should Contain X Times    ${output}    priority : 10274    2
