...
Start Sender
    ...
    Write    cd ${SALWorkDir}/${subSystem}/cpp/src
    Comment    Start Sender.
    ${input}=    Write    ./sacpp_${subSystem}_${component}_send 0 60.4058 -256939740
    ${output}=    Read Until Prompt
    Log    ${output}
...
Read Logger
    [Tags]    functional
    Switch Connection    Logger
    ${output}=    Read Until    priority : -256939740
    Log    ${output}
    ...
    Should Contain    ${output}    timestamp : 60.4058
    Should Contain    ${output}    priority : -256939740
