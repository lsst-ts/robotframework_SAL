...
Start Sender
    ...
    Write    cd ${SALWorkDir}/${subSystem}/cpp/src
    Comment    Start Sender.
    ${input}=    Write    ./sacpp_${subSystem}_${component}_send 0 1245535143 -1968433915
    ${output}=    Read Until Prompt
    Log    ${output}
...
Read Logger
    [Tags]    functional
    Switch Connection    Logger
    ${output}=    Read Until    priority : -1968433915
    Log    ${output}
    ...
    Should Contain    ${output}    priority : 1245535143
    Should Contain    ${output}    priority : -1968433915
