...
Start Sender
    ...
    Write    cd ${SALWorkDir}/${subSystem}/cpp/src
    Comment    Start Sender.
    ${input}=    Write    ./sacpp_${subSystem}_${component}_send test 60.725 test 592947894 test test test test test 521092656
    ${output}=    Read Until Prompt
    Log    ${output}
...
Read Logger
    ...
    Should Contain    ${output}    priority : 521092656
