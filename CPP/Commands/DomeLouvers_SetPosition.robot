...
Start Commander - Verify Timeout without Controller
    ...
    Write    cd ${SALWorkDir}/${subSystem}/cpp/src
    Comment    Start Commander.
    ${input}=    Write    ./sacpp_${subSystem}_${component}_commander 27068 -32645
    ${output}=    Read Until Prompt
    Log    ${output}
...
Start Commander
    ...
    Should Contain X Times    ${output}    louverID : 27068    1
    Should Contain X Times    ${output}    position : -32645    1
...
Read Controller
    ...
    Log    ${output}
    Should Contain    ${output}    === command SetPosition received =
