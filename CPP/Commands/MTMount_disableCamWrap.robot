...
Start Commander
    ...
    ${output}=    Read Until Prompt
    Log    ${output}
    Should Contain X Times    ${output}    === [issueCommandC disableCamWrap] writing a command containing :    1
    Should Contain X Times    ${output}    device : wrap    1
    Should Contain X Times    ${output}    property : mode    1
    Should Contain X Times    ${output}    action :     1
    Should Contain X Times    ${output}    value :     1
    Should Contain    ${output}    === command disableCamWrap issued =
...
Read Controller
    ...
    Log    ${output}
    Should Contain    ${output}    === [acceptCommandC disableCamWrap] reading a command containing :
    ...
    Should Contain    ${output}    value \ \ \ : 
    Should Contain    ${output}    === command disableCamWrap received =
