...
Start Commander - Verify Timeout without Controller
    ...
    Write    cd ${SALWorkDir}/${subSystem}/cpp/src
    Comment    Start Commander.
    ${input}=    Write    ./sacpp_${subSystem}_${component}_commander 36.038 75.0132 136855446
    ${output}=    Read Until Prompt
    Log    ${output}
...
Start Commander
    ...
    Should Contain X Times    ${output}    azPosition : 36.038    1
    Should Contain X Times    ${output}    elPosition : 75.0132    1
    Should Contain X Times    ${output}    demandTime : 136855446    1
