...
Start Commander - Verify Timeout without Controller
    ...
    Write    cd ${SALWorkDir}/${subSystem}/cpp/src
    Comment    Start Commander.
    ${input}=    Write    ./sacpp_${subSystem}_${component}_commander 63.7909 87.8225 -226554676
    ${output}=    Read Until Prompt
    Log    ${output}
...
Start Commander
    ...
    Should Contain X Times    ${output}    azPosition : 63.7909    1
    Should Contain X Times    ${output}    elPosition : 87.8225    1
    Should Contain X Times    ${output}    demandTime : -226554676    1
