...
Start Commander - Verify Timeout without Controller
    ...
    Write    cd ${SALWorkDir}/${subSystem}/cpp/src
    Comment    Start Commander.
    ${input}=    Write    ./sacpp_${subSystem}_${component}_commander 30.8658 32.4393 -445959654
    ${output}=    Read Until Prompt
    Log    ${output}
...
Start Commander
    ...
    Should Contain X Times    ${output}    azPosition : 30.8658    1
    Should Contain X Times    ${output}    elPosition : 32.4393    1
    Should Contain X Times    ${output}    demandTime : -445959654    1
