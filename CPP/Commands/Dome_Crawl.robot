...
Start Commander - Verify Timeout without Controller
    ...
    Write    cd ${SALWorkDir}/${subSystem}/cpp/src
    Comment    Start Commander.
    ${input}=    Write    ./sacpp_${subSystem}_${component}_commander 39.0511 80.8662 -1525165923
    ${output}=    Read Until Prompt
    Log    ${output}
...
Start Commander
    ...
    Should Contain X Times    ${output}    azPosition : 39.0511    1
    Should Contain X Times    ${output}    elPosition : 80.8662    1
    Should Contain X Times    ${output}    demandTime : -1525165923    1
