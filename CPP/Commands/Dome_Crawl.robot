...
Start Commander - Verify Timeout without Controller
    ...
    Write    cd ${SALWorkDir}/${subSystem}/cpp/src
    Comment    Start Commander.
    ${input}=    Write    ./sacpp_${subSystem}_${component}_commander 95.4009 73.312 -483479201
    ${output}=    Read Until Prompt
    Log    ${output}
...
Start Commander
    ...
    Should Contain X Times    ${output}    azPosition : 95.4009    1
    Should Contain X Times    ${output}    elPosition : 73.312    1
    Should Contain X Times    ${output}    demandTime : -483479201    1
