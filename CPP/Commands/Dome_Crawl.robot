...
Start Commander - Verify Timeout without Controller
    ...
    Write    cd ${SALWorkDir}/${subSystem}/cpp/src
    Comment    Start Commander.
    ${input}=    Write    ./sacpp_${subSystem}_${component}_commander 72.7578 79.425 1140731424
    ${output}=    Read Until Prompt
    Log    ${output}
...
Start Commander
    ...
    Should Contain X Times    ${output}    azPosition : 72.7578    1
    Should Contain X Times    ${output}    elPosition : 79.425    1
    Should Contain X Times    ${output}    demandTime : 1140731424    1
