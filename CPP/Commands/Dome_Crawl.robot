...
Start Commander - Verify Timeout without Controller
    ...
    Write    cd ${SALWorkDir}/${subSystem}/cpp/src
    Comment    Start Commander.
    ${input}=    Write    ./sacpp_${subSystem}_${component}_commander 49.2075 30.0505 -1480281599
    ${output}=    Read Until Prompt
    Log    ${output}
...
Start Commander
    ...
    Should Contain X Times    ${output}    azPosition : 49.2075    1
    Should Contain X Times    ${output}    elPosition : 30.0505    1
    Should Contain X Times    ${output}    demandTime : -1480281599    1
