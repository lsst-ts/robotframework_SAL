...
Start Commander - Verify Timeout without Controller
    ...
    Write    cd ${SALWorkDir}/${subSystem}/cpp/src
    Comment    Start Commander.
    ${input}=    Write    ./sacpp_${subSystem}_${component}_commander 51.4175 72.0422 765957071
    ${output}=    Read Until Prompt
    Log    ${output}
...
Start Commander
    ...
    Should Contain X Times    ${output}    azPosition : 51.4175    1
    Should Contain X Times    ${output}    elPosition : 72.0422    1
    Should Contain X Times    ${output}    demandTime : 765957071    1
