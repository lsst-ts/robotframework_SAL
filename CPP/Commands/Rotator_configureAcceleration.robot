...
Start Commander - Verify Timeout without Controller
    ...
    Write    cd ${SALWorkDir}/${subSystem}/cpp/src
    Comment    Start Commander.
    ${input}=    Write    ./sacpp_${subSystem}_${component}_commander 5.6534 6.2387
    ${output}=    Read Until Prompt
    Log    ${output}
...
Start Commander
    ...
    Should Contain X Times    ${output}    amin : 5.6534    1
    Should Contain X Times    ${output}    amax : 6.2387    1
