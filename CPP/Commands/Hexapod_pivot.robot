...
Start Commander - Verify Timeout without Controller
    ...
    Write    cd ${SALWorkDir}/${subSystem}/cpp/src
    Comment    Start Commander.
    ${input}=    Write    ./sacpp_${subSystem}_${component}_commander 0.3129 35.9529 85.4517
    ${output}=    Read Until Prompt
    Log    ${output}
...
Start Commander
    ...
    Should Contain X Times    ${output}    x : 0.3129    1
    Should Contain X Times    ${output}    y : 35.9529    1
    Should Contain X Times    ${output}    z : 85.4517    1
