*** Settings ***
Documentation    MTMount_openMirrorCover commander/controller tests.
...
Start Commander
    ...
    ${output}=    Read Until Prompt
    Log    ${output}
    Should Contain X Times    ${output}    === [issueCommandC openMirrorCover] writing a command containing :    1
    Should Contain X Times    ${output}    device : mirrorCover    1
    Should Contain X Times    ${output}    property : position    1
    Should Contain X Times    ${output}    action :     1
    Should Contain X Times    ${output}    value :     1
    Should Contain    ${output}    === command openMirrorCover issued =
...
Read Controller
    ...
    Log    ${output}
    Should Contain    ${output}    === [acceptCommandC openMirrorCover] reading a command containing :
    ...
    Should Contain    ${output}    value \ \ \ : 
    Should Contain    ${output}    === command openMirrorCover received =
