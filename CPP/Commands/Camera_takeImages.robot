...
Start Commander
    ...
    Write    cd ${SALWorkDir}/${subSystem}/cpp/src
    Comment    Start Commander.
    ${input}=    Write    ./sacpp_${subSystem}_${component}_commander 76.404823031 20.59 1 1 1 1 test    #|tee ${comOut}
    ${output}=    Read Until Prompt
    Log    ${output}
	...
	Comment    TSS-677
    Should Contain X Times    ${output}    numImages :     1    #76.404823031    1
    Should Contain X Times    ${output}    expTime : 20.59    1
