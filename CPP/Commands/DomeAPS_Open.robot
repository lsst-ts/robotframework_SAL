*** Settings ***
Documentation    DomeAPS_Open commander/controller tests.
Force Tags    cpp
...
Start Commander
    ...
    Should Contain    ${output}    === command Open issued =
    ${CmdComplete}=    Get Line    ${output}    -2
...
Read Controller
    ...
    Log    ${output}
    Should Contain    ${output}    === command Open received =
    Should Contain    ${output}    device : aps
    Should Contain    ${output}    property : position
    Should Contain    ${output}    action : 
    Should Contain    ${output}    value : 
    Should Contain X Times    ${output}    state : 1    1
    Should Contain X Times    ${output}    === [ackCommand_Open] acknowledging a command with :    2
