...
Start Commander - Verify Timeout without Controller
    ...
    Write    cd ${SALWorkDir}/${subSystem}/cpp/src
    Comment    Start Commander.
    ${input}=    Write    ./sacpp_${subSystem}_${component}_commander 0 0 0 0 1 1 1 0
    ${output}=    Read Until Prompt
    Log    ${output}
...
Start Commander
    ...
    Should Contain X Times    ${output}    TurnPowerNetworkDOff : 0    1
    Should Contain X Times    ${output}    TurnAuxPowerNetworkAOff : 1    1
    Should Contain X Times    ${output}    TurnAuxPowerNetworkBOff : 1    1
    Should Contain X Times    ${output}    TurnAuxPowerNetworkCOff : 1    1
    Should Contain X Times    ${output}    TurnAuxPowerNetworkDOff : 0    1
...
Read Controller
    ...
    Log    ${output}
    Should Contain    ${output}    === command TurnPowerOff received =
