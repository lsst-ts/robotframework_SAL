...
Start Commander - Verify Timeout without Controller
    ...
    Write    cd ${SALWorkDir}/${subSystem}/cpp/src
    Comment    Start Commander.
    ${input}=    Write    ./sacpp_${subSystem}_${component}_commander 73.5498 99.3043 13.9181
    ${output}=    Read Until Prompt
    Log    ${output}
...
Start Commander
    ...
    Should Contain X Times    ${output}    xTilt : 73.5498    1
    Should Contain X Times    ${output}    yTilt : 99.3043    1
    Should Contain X Times    ${output}    piston : 13.9181    1
