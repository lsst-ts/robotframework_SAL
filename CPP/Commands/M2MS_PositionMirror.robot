...
Start Commander - Verify Timeout without Controller
    ...
    Write    cd ${SALWorkDir}/${subSystem}/cpp/src
    Comment    Start Commander.
    ${input}=    Write    ./sacpp_${subSystem}_${component}_commander 44.0425 86.3128 10.3105
    ${output}=    Read Until Prompt
    Log    ${output}
...
Start Commander
    ...
    Should Contain X Times    ${output}    xTilt : 44.0425    1
    Should Contain X Times    ${output}    yTilt : 86.3128    1
    Should Contain X Times    ${output}    piston : 10.3105    1
