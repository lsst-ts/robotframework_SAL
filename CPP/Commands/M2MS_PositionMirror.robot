...
Start Commander - Verify Timeout without Controller
    ...
    Write    cd ${SALWorkDir}/${subSystem}/cpp/src
    Comment    Start Commander.
    ${input}=    Write    ./sacpp_${subSystem}_${component}_commander 90.2336 12.0489 75.6623
    ${output}=    Read Until Prompt
    Log    ${output}
...
Start Commander
    ...
    Should Contain X Times    ${output}    xTilt : 90.2336    1
    Should Contain X Times    ${output}    yTilt : 12.0489    1
    Should Contain X Times    ${output}    piston : 75.6623    1
