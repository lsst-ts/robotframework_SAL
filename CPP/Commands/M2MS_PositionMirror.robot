...
Start Commander - Verify Timeout without Controller
    ...
    Write    cd ${SALWorkDir}/${subSystem}/cpp/src
    Comment    Start Commander.
    ${input}=    Write    ./sacpp_${subSystem}_${component}_commander 68.5317 78.5577 27.7249
    ${output}=    Read Until Prompt
    Log    ${output}
...
Start Commander
    ...
    Should Contain X Times    ${output}    xTilt : 68.5317    1
    Should Contain X Times    ${output}    yTilt : 78.5577    1
    Should Contain X Times    ${output}    piston : 27.7249    1
