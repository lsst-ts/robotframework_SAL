*** Settings ***
Documentation    M2MS_AxialActuatorPositionAbsoluteEncoderPositionMeasured communications tests.
...
Read Subscriber
    [Tags]    functional
    Switch Connection    Subscriber
    ${output}=    Read Until    axialEncoderPositionMeasured : 0
    Log    ${output}
    ...
    Should Contain X Times    ${output}    axialEncoderPositionMeasured :    10
