*** Settings ***
Documentation    M2MS_ZenithAngleMeasured communications tests.
...
Read Subscriber
    [Tags]    functional
    Switch Connection    Subscriber
    ${output}=    Read Until    ZenithAngleMeasured : 0
    Log    ${output}
    ...
    Should Contain X Times    ${output}    ZenithAngleMeasured :    10
