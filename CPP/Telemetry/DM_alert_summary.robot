...
Read Subscriber
    ...
    ${output}=    Read
    Log    ${output}
    Should Contain X Times    ${output}    alerts_sent :    10
    Should Contain X Times    ${output}    available_workers :    10
    Should Contain X Times    ${output}    latency_readout_to_last_alert :    10
