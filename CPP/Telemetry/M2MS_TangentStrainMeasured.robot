...
Read Subscriber
    [Tags]    functional
    Switch Connection    Subscriber
    ${output}=    Read Until    tangentLink_300deg_strainsMeasured : 0
    Log    ${output}
    ...
    Should Contain X Times    ${output}    tangentLink_0deg_strainsMeasured :    10
    Should Contain X Times    ${output}    tangentLink_60deg_strainsMeasured :    10
    Should Contain X Times    ${output}    tangentLink_120deg_strainsMeasured :    10
    Should Contain X Times    ${output}    tangentLink_180deg_strainsMeasured :    10
    Should Contain X Times    ${output}    tangentLink_240deg_strainsMeasured :    10
    Should Contain X Times    ${output}    tangentLink_300deg_strainsMeasured :    10
