...
Read Subscriber
    ...
    Log    ${output}
    Should Contain X Times    ${output}    distance : 1    1
    Should Contain X Times    ${output}    distance : 2    1
    Should Contain X Times    ${output}    distance : 3    1
    Should Contain X Times    ${output}    distance : 4    1
    Should Contain X Times    ${output}    distance : 5    1
    Should Contain X Times    ${output}    distance : 6    1
    Should Contain X Times    ${output}    distance : 7    1
    Should Contain X Times    ${output}    distance : 8    1
    Should Contain X Times    ${output}    distance : 9    1
