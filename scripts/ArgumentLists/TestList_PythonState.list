...
# Define filename
argfile=$HOME/trunk/robotframework_SAL/PythonStateMachine_Tests.list
...
ls -1 $HOME/trunk/robotframework_SAL/PYTHON/StateMachine |sed 's/^/PYTHON\/StateMachine\//' >> $argfile
