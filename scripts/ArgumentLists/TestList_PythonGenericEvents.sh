...
# Define filename
argfile=$HOME/trunk/robotframework_SAL/PythonGenericEvents_Tests.list
...
ls -1 $HOME/trunk/robotframework_SAL/PYTHON/GenericEvents/ |sed 's/^/PYTHON\/GenericEvents\//' >> $argfile
