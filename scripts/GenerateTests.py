...
csc_array = ['ATAOS', 'ATArchiver', 'ATAOS', 'ATBuilding', 'ATCamera', 'ATDome', 'ATDomeTrajectory', 'ATHeaderService', 'ATHexapod', 'ATMCS', 'ATMonochromator', 'ATPneumatics', 'ATPtg', 'ATSpectrograph', 'ATTCS', 'ATWhiteLight', 'CatchupArchiver', 'CBP', 'DIMM', 'Dome', 'EAS', 'EFD', 'EFDTransformationServer', 'Electrometer', 'Environment', 'FiberSpectrograph', 'IOTA', 'Hexapod', 'GenericCamera', 'HVAC', 'LinearStage', 'MTArchiver', 'MTCamera', 'MTDomeTrajectory', 'MTEEC', 'MTGuider', 'MTHeaderService', 'MTLaserTracker', 'MTM1M3', 'MTM1M3TS', 'MTM2', 'MTMount', 'MTPtg', 'MTTCS', 'MTVMS', 'OCS', 'PointingComponent', 'PromptProcessing', 'Rotator', 'Scheduler', 'Script', 'ScriptQueue', 'SummitFacility', 'Test', 'TunableLaser', 'Watcher']
