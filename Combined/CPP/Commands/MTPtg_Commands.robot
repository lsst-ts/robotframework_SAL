*** Settings ***
Documentation    MTPtg_Commands communications tests.
...
Start Commander
    ...
    ${pointCloseFile_start}=    Get Index From List    ${full_list}    === MTPtg_pointCloseFile start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${poriginAbsorb_start}=    Get Index From List    ${full_list}    === MTPtg_poriginAbsorb start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${guideClear_start}=    Get Index From List    ${full_list}    === MTPtg_guideClear start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${collOffset_start}=    Get Index From List    ${full_list}    === MTPtg_collOffset start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${rotOffset_start}=    Get Index From List    ${full_list}    === MTPtg_rotOffset start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${clearCollOffset_start}=    Get Index From List    ${full_list}    === MTPtg_clearCollOffset start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${poriginXY_start}=    Get Index From List    ${full_list}    === MTPtg_poriginXY start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${iersUpdate_start}=    Get Index From List    ${full_list}    === MTPtg_iersUpdate start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${offsetRADec_start}=    Get Index From List    ${full_list}    === MTPtg_offsetRADec start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${pointAddData_start}=    Get Index From List    ${full_list}    === MTPtg_pointAddData start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${guideControl_start}=    Get Index From List    ${full_list}    === MTPtg_guideControl start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${offsetAbsorb_start}=    Get Index From List    ${full_list}    === MTPtg_offsetAbsorb start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${ephemTarget_start}=    Get Index From List    ${full_list}    === MTPtg_ephemTarget start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${wavelength_start}=    Get Index From List    ${full_list}    === MTPtg_wavelength start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${pointLoadModel_start}=    Get Index From List    ${full_list}    === MTPtg_pointLoadModel start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${azCurrentWrap_start}=    Get Index From List    ${full_list}    === MTPtg_azCurrentWrap start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${debugLevel_start}=    Get Index From List    ${full_list}    === MTPtg_debugLevel start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${raDecTarget_start}=    Get Index From List    ${full_list}    === MTPtg_raDecTarget start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${offsetPA_start}=    Get Index From List    ${full_list}    === MTPtg_offsetPA start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${rotCurrentWrap_start}=    Get Index From List    ${full_list}    === MTPtg_rotCurrentWrap start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${poriginOffset_start}=    Get Index From List    ${full_list}    === MTPtg_poriginOffset start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${offsetClear_start}=    Get Index From List    ${full_list}    === MTPtg_offsetClear start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${offsetAzEl_start}=    Get Index From List    ${full_list}    === MTPtg_offsetAzEl start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${azElTarget_start}=    Get Index From List    ${full_list}    === MTPtg_azElTarget start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${planetTarget_start}=    Get Index From List    ${full_list}    === MTPtg_planetTarget start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${pointNewFile_start}=    Get Index From List    ${full_list}    === MTPtg_pointNewFile start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${poriginClear_start}=    Get Index From List    ${full_list}    === MTPtg_poriginClear start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${focusName_start}=    Get Index From List    ${full_list}    === MTPtg_focusName start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${amLimitSet_start}=    Get Index From List    ${full_list}    === MTPtg_amLimitSet start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${stopTracking_start}=    Get Index From List    ${full_list}    === MTPtg_stopTracking start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${startTracking_start}=    Get Index From List    ${full_list}    === MTPtg_startTracking start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${disable_start}=    Get Index From List    ${full_list}    === MTPtg_disable start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${enable_start}=    Get Index From List    ${full_list}    === MTPtg_enable start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${exitControl_start}=    Get Index From List    ${full_list}    === MTPtg_exitControl start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${setLogLevel_start}=    Get Index From List    ${full_list}    === MTPtg_setLogLevel start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${standby_start}=    Get Index From List    ${full_list}    === MTPtg_standby start of topic ===
    ...
    Should Contain    ${output.stdout}    ==== ${subSystem} all commanders ready ====
    ${start_start}=    Get Index From List    ${full_list}    === MTPtg_start start of topic ===
...
Read Controller
    ...
    ${pointCloseFile_start}=    Get Index From List    ${full_list}    === MTPtg_pointCloseFile start of topic ===
    ${pointCloseFile_end}=    Get Index From List    ${full_list}    === MTPtg_pointCloseFile end of topic ===
    ...
    ${poriginAbsorb_start}=    Get Index From List    ${full_list}    === MTPtg_poriginAbsorb start of topic ===
    ${poriginAbsorb_end}=    Get Index From List    ${full_list}    === MTPtg_poriginAbsorb end of topic ===
    ...
    ${guideClear_start}=    Get Index From List    ${full_list}    === MTPtg_guideClear start of topic ===
    ${guideClear_end}=    Get Index From List    ${full_list}    === MTPtg_guideClear end of topic ===
    ...
    ${collOffset_start}=    Get Index From List    ${full_list}    === MTPtg_collOffset start of topic ===
    ${collOffset_end}=    Get Index From List    ${full_list}    === MTPtg_collOffset end of topic ===
    ...
    ${rotOffset_start}=    Get Index From List    ${full_list}    === MTPtg_rotOffset start of topic ===
    ${rotOffset_end}=    Get Index From List    ${full_list}    === MTPtg_rotOffset end of topic ===
    ...
    ${clearCollOffset_start}=    Get Index From List    ${full_list}    === MTPtg_clearCollOffset start of topic ===
    ${clearCollOffset_end}=    Get Index From List    ${full_list}    === MTPtg_clearCollOffset end of topic ===
    ...
    ${poriginXY_start}=    Get Index From List    ${full_list}    === MTPtg_poriginXY start of topic ===
    ${poriginXY_end}=    Get Index From List    ${full_list}    === MTPtg_poriginXY end of topic ===
    ...
    ${iersUpdate_start}=    Get Index From List    ${full_list}    === MTPtg_iersUpdate start of topic ===
    ${iersUpdate_end}=    Get Index From List    ${full_list}    === MTPtg_iersUpdate end of topic ===
    ...
    ${offsetRADec_start}=    Get Index From List    ${full_list}    === MTPtg_offsetRADec start of topic ===
    ${offsetRADec_end}=    Get Index From List    ${full_list}    === MTPtg_offsetRADec end of topic ===
    ...
    ${pointAddData_start}=    Get Index From List    ${full_list}    === MTPtg_pointAddData start of topic ===
    ${pointAddData_end}=    Get Index From List    ${full_list}    === MTPtg_pointAddData end of topic ===
    ...
    ${guideControl_start}=    Get Index From List    ${full_list}    === MTPtg_guideControl start of topic ===
    ${guideControl_end}=    Get Index From List    ${full_list}    === MTPtg_guideControl end of topic ===
    ...
    ${offsetAbsorb_start}=    Get Index From List    ${full_list}    === MTPtg_offsetAbsorb start of topic ===
    ${offsetAbsorb_end}=    Get Index From List    ${full_list}    === MTPtg_offsetAbsorb end of topic ===
    ...
    ${ephemTarget_start}=    Get Index From List    ${full_list}    === MTPtg_ephemTarget start of topic ===
    ${ephemTarget_end}=    Get Index From List    ${full_list}    === MTPtg_ephemTarget end of topic ===
    ...
    ${wavelength_start}=    Get Index From List    ${full_list}    === MTPtg_wavelength start of topic ===
    ${wavelength_end}=    Get Index From List    ${full_list}    === MTPtg_wavelength end of topic ===
    ...
    ${pointLoadModel_start}=    Get Index From List    ${full_list}    === MTPtg_pointLoadModel start of topic ===
    ${pointLoadModel_end}=    Get Index From List    ${full_list}    === MTPtg_pointLoadModel end of topic ===
    ...
    ${azCurrentWrap_start}=    Get Index From List    ${full_list}    === MTPtg_azCurrentWrap start of topic ===
    ${azCurrentWrap_end}=    Get Index From List    ${full_list}    === MTPtg_azCurrentWrap end of topic ===
    ...
    ${debugLevel_start}=    Get Index From List    ${full_list}    === MTPtg_debugLevel start of topic ===
    ${debugLevel_end}=    Get Index From List    ${full_list}    === MTPtg_debugLevel end of topic ===
    ...
    ${raDecTarget_start}=    Get Index From List    ${full_list}    === MTPtg_raDecTarget start of topic ===
    ${raDecTarget_end}=    Get Index From List    ${full_list}    === MTPtg_raDecTarget end of topic ===
    ...
    ${offsetPA_start}=    Get Index From List    ${full_list}    === MTPtg_offsetPA start of topic ===
    ${offsetPA_end}=    Get Index From List    ${full_list}    === MTPtg_offsetPA end of topic ===
    ...
    ${rotCurrentWrap_start}=    Get Index From List    ${full_list}    === MTPtg_rotCurrentWrap start of topic ===
    ${rotCurrentWrap_end}=    Get Index From List    ${full_list}    === MTPtg_rotCurrentWrap end of topic ===
    ...
    ${poriginOffset_start}=    Get Index From List    ${full_list}    === MTPtg_poriginOffset start of topic ===
    ${poriginOffset_end}=    Get Index From List    ${full_list}    === MTPtg_poriginOffset end of topic ===
    ...
    ${offsetClear_start}=    Get Index From List    ${full_list}    === MTPtg_offsetClear start of topic ===
    ${offsetClear_end}=    Get Index From List    ${full_list}    === MTPtg_offsetClear end of topic ===
    ...
    ${offsetAzEl_start}=    Get Index From List    ${full_list}    === MTPtg_offsetAzEl start of topic ===
    ${offsetAzEl_end}=    Get Index From List    ${full_list}    === MTPtg_offsetAzEl end of topic ===
    ...
    ${azElTarget_start}=    Get Index From List    ${full_list}    === MTPtg_azElTarget start of topic ===
    ${azElTarget_end}=    Get Index From List    ${full_list}    === MTPtg_azElTarget end of topic ===
    ...
    ${planetTarget_start}=    Get Index From List    ${full_list}    === MTPtg_planetTarget start of topic ===
    ${planetTarget_end}=    Get Index From List    ${full_list}    === MTPtg_planetTarget end of topic ===
    ...
    ${pointNewFile_start}=    Get Index From List    ${full_list}    === MTPtg_pointNewFile start of topic ===
    ${pointNewFile_end}=    Get Index From List    ${full_list}    === MTPtg_pointNewFile end of topic ===
    ...
    ${poriginClear_start}=    Get Index From List    ${full_list}    === MTPtg_poriginClear start of topic ===
    ${poriginClear_end}=    Get Index From List    ${full_list}    === MTPtg_poriginClear end of topic ===
    ...
    ${focusName_start}=    Get Index From List    ${full_list}    === MTPtg_focusName start of topic ===
    ${focusName_end}=    Get Index From List    ${full_list}    === MTPtg_focusName end of topic ===
    ...
    ${amLimitSet_start}=    Get Index From List    ${full_list}    === MTPtg_amLimitSet start of topic ===
    ${amLimitSet_end}=    Get Index From List    ${full_list}    === MTPtg_amLimitSet end of topic ===
    ...
    ${stopTracking_start}=    Get Index From List    ${full_list}    === MTPtg_stopTracking start of topic ===
    ${stopTracking_end}=    Get Index From List    ${full_list}    === MTPtg_stopTracking end of topic ===
    ...
    ${startTracking_start}=    Get Index From List    ${full_list}    === MTPtg_startTracking start of topic ===
    ${startTracking_end}=    Get Index From List    ${full_list}    === MTPtg_startTracking end of topic ===
    ...
    ${disable_start}=    Get Index From List    ${full_list}    === MTPtg_disable start of topic ===
    ${disable_end}=    Get Index From List    ${full_list}    === MTPtg_disable end of topic ===
    ...
    ${enable_start}=    Get Index From List    ${full_list}    === MTPtg_enable start of topic ===
    ${enable_end}=    Get Index From List    ${full_list}    === MTPtg_enable end of topic ===
    ...
    ${exitControl_start}=    Get Index From List    ${full_list}    === MTPtg_exitControl start of topic ===
    ${exitControl_end}=    Get Index From List    ${full_list}    === MTPtg_exitControl end of topic ===
    ...
    ${setLogLevel_start}=    Get Index From List    ${full_list}    === MTPtg_setLogLevel start of topic ===
    ${setLogLevel_end}=    Get Index From List    ${full_list}    === MTPtg_setLogLevel end of topic ===
    ...
    ${standby_start}=    Get Index From List    ${full_list}    === MTPtg_standby start of topic ===
    ${standby_end}=    Get Index From List    ${full_list}    === MTPtg_standby end of topic ===
    ...
    ${start_start}=    Get Index From List    ${full_list}    === MTPtg_start start of topic ===
    ${start_end}=    Get Index From List    ${full_list}    === MTPtg_start end of topic ===
