...
Start Subscriber
    ...
    Should Contain    ${string}    ===== DomeADB subscribers ready =====
...
Read Subscriber
    ...
    ${status_start}=    Get Index From List    ${full_list}    === DomeADB_status start of topic ===
    ${status_end}=    Get Index From List    ${full_list}    === DomeADB_status end of topic ===
