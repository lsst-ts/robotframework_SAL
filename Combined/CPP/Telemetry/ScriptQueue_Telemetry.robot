*** Settings ***
Documentation    ScriptQueue Telemetry communications tests.
Force Tags    cpp    
...
Start Subscriber
    ...
    Should Contain    ${string}    ===== ScriptQueue subscribers ready =====
...
Read Subscriber
    ...
    Log Many    ${output.stdout}    ${output.stderr}
    Should Contain    ${output.stdout}    ===== ScriptQueue subscribers ready =====
