*** Settings ***
Documentation    OCS Telemetry communications tests.
Force Tags    cpp    
...
Start Subscriber
    ...
    Should Contain    ${output}    ===== OCS subscribers ready =====
    Sleep    6s
...
Start Publisher
    ...
    Should Contain    ${output.stdout}    === OCS_sequencerHeartbeat start of topic ===
    ...
    Should Contain    ${output.stdout}    === OCS_sequencerHeartbeat end of topic ===
...
Read Subscriber
    ...
    Log Many    ${output.stdout}    ${output.stderr}
    Should Contain    ${output.stdout}    ===== OCS subscribers ready =====
