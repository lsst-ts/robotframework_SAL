*** Settings ***
Documentation    Environment Telemetry communications tests.
Force Tags    cpp    
...
Start Subscriber
    ...
    Should Contain    ${output}    ===== Environment subscribers ready =====
...
Start Publisher
    ...
    Should Contain    ${output.stdout}    === Environment_weather end of topic ===
    ...
    Should Contain X Times    ${output.stdout}    revCode \ : ${revcode}    10
    Should Contain    ${output.stdout}    === Environment_windDirection end of topic ===
    ...
    Should Contain X Times    ${output.stdout}    revCode \ : ${revcode}    10
    Should Contain    ${output.stdout}    === Environment_windGustDirection end of topic ===
    ...
    Should Contain X Times    ${output.stdout}    revCode \ : ${revcode}    10
    Should Contain    ${output.stdout}    === Environment_windSpeed end of topic ===
    ...
    Should Contain X Times    ${output.stdout}    revCode \ : ${revcode}    10
    Should Contain    ${output.stdout}    === Environment_airTemperature end of topic ===
    ...
    Should Contain X Times    ${output.stdout}    revCode \ : ${revcode}    10
    Should Contain    ${output.stdout}    === Environment_relativeHumidity end of topic ===
    ...
    Should Contain X Times    ${output.stdout}    revCode \ : ${revcode}    10
    Should Contain    ${output.stdout}    === Environment_dewPoint end of topic ===
    ...
    Should Contain X Times    ${output.stdout}    revCode \ : ${revcode}    10
    Should Contain    ${output.stdout}    === Environment_snowDepth end of topic ===
    ...
    Should Contain X Times    ${output.stdout}    revCode \ : ${revcode}    10
    Should Contain    ${output.stdout}    === Environment_solarNetRadiation end of topic ===
    ...
    Should Contain X Times    ${output.stdout}    revCode \ : ${revcode}    10
    Should Contain    ${output.stdout}    === Environment_airPressure end of topic ===
    ...
    Should Contain X Times    ${output.stdout}    revCode \ : ${revcode}    10
    Should Contain    ${output.stdout}    === Environment_precipitation end of topic ===
    ...
    Should Contain X Times    ${output.stdout}    revCode \ : ${revcode}    10
    Should Contain    ${output.stdout}    === Environment_soilTemperature end of topic ===
