*** Settings ***
Documentation    DomeAPS Telemetry communications tests.
Force Tags    cpp    
...
Start Subscriber
    ...
    Should Contain    ${output}    ===== DomeAPS subscribers ready =====
    Sleep    6s
...
Read Subscriber
    ...
    ${status_start}=    Get Index From List    ${full_list}    === DomeAPS_status start of topic ===
    ${status_end}=    Get Index From List    ${full_list}    === DomeAPS_status end of topic ===
