*** Settings ***
Documentation    ATHeaderService Telemetry communications tests.
Force Tags    cpp    
...
Start Subscriber
    ...
    Should Contain    ${string}    ===== ATHeaderService subscribers ready =====
...
Read Subscriber
    ...
    Log Many    ${output.stdout}    ${output.stderr}
    Should Contain    ${output.stdout}    ===== ATHeaderService subscribers ready =====
