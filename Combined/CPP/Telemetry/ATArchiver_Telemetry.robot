*** Settings ***
Documentation    ATArchiver Telemetry communications tests.
Force Tags    cpp    
...
Start Subscriber
    ...
    Should Contain    ${string}    ===== ATArchiver subscribers ready =====
...
Start Publisher
    ...
    Should Contain    ${output.stdout}    === ATArchiver_sequencerHeartbeat start of topic ===
    ...
    Should Contain    ${output.stdout}    === ATArchiver_sequencerHeartbeat end of topic ===
...
Read Subscriber
    ...
    Log Many    ${output.stdout}    ${output.stderr}
    Should Contain    ${output.stdout}    ===== ATArchiver subscribers ready =====
