...
Start Subscriber
    ...
    Wait Until Keyword Succeeds    60s    10    File Should Contain    ${EXECDIR}${/}${subSystem}_stdout.txt    ===== MTMount subscribers ready =====
...
Start Publisher
    ...
    ${line}=    Grep File    ${SALWorkDir}/avro-templates/${subSystem}/${subSystem}_hash_table.json    "capacitorBank"
    ${line}=    Remove String    ${line}    \"    \:    \,
    @{words}=    Split String    ${line}
    ${revcode}=    Set Variable    ${words}[1]
    Comment    ======= Verify ${subSystem}_capacitorBank test messages =======
    Should Contain    ${output.stdout}    === MTMount_capacitorBank start of topic ===
    Should Contain X Times    ${output.stdout}    [putSample] ${subSystem}.capacitorBank writing a message containing :    10
    Should Contain X Times    ${output.stdout}    revCode \ : ${revcode}    10
    Should Contain    ${output.stdout}    === MTMount_capacitorBank end of topic ===
...
Read Subscriber
    ...
    ${capacitorBank_start}=    Get Index From List    ${full_list}    === MTMount_capacitorBank start of topic ===
    ${capacitorBank_end}=    Get Index From List    ${full_list}    === MTMount_capacitorBank end of topic ===
    ${capacitorBank_list}=    Get Slice From List    ${full_list}    start=${capacitorBank_start}    end=${capacitorBank_end}
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth3Fuse : 0    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth3Fuse : 1    9
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth3FuseTimestamp : 0    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth3FuseTimestamp : 1    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth3FuseTimestamp : 2    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth3FuseTimestamp : 3    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth3FuseTimestamp : 4    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth3FuseTimestamp : 5    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth3FuseTimestamp : 6    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth3FuseTimestamp : 7    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth3FuseTimestamp : 8    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth3FuseTimestamp : 9    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth4Fuse : 0    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth4Fuse : 1    9
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth4FuseTimestamp : 0    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth4FuseTimestamp : 1    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth4FuseTimestamp : 2    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth4FuseTimestamp : 3    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth4FuseTimestamp : 4    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth4FuseTimestamp : 5    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth4FuseTimestamp : 6    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth4FuseTimestamp : 7    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth4FuseTimestamp : 8    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth4FuseTimestamp : 9    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth5Fuse : 0    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth5Fuse : 1    9
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth5FuseTimestamp : 0    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth5FuseTimestamp : 1    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth5FuseTimestamp : 2    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth5FuseTimestamp : 3    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth5FuseTimestamp : 4    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth5FuseTimestamp : 5    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth5FuseTimestamp : 6    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth5FuseTimestamp : 7    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth5FuseTimestamp : 8    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth5FuseTimestamp : 9    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth6Fuse : 0    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth6Fuse : 1    9
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth6FuseTimestamp : 0    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth6FuseTimestamp : 1    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth6FuseTimestamp : 2    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth6FuseTimestamp : 3    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth6FuseTimestamp : 4    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth6FuseTimestamp : 5    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth6FuseTimestamp : 6    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth6FuseTimestamp : 7    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth6FuseTimestamp : 8    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownAzimuth6FuseTimestamp : 9    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownElevation7Fuse : 0    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownElevation7Fuse : 1    9
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownElevation7FuseTimestamp : 0    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownElevation7FuseTimestamp : 1    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownElevation7FuseTimestamp : 2    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownElevation7FuseTimestamp : 3    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownElevation7FuseTimestamp : 4    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownElevation7FuseTimestamp : 5    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownElevation7FuseTimestamp : 6    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownElevation7FuseTimestamp : 7    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownElevation7FuseTimestamp : 8    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownElevation7FuseTimestamp : 9    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownElevation8Fuse : 0    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownElevation8Fuse : 1    9
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownElevation8FuseTimestamp : 0    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownElevation8FuseTimestamp : 1    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownElevation8FuseTimestamp : 2    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownElevation8FuseTimestamp : 3    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownElevation8FuseTimestamp : 4    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownElevation8FuseTimestamp : 5    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownElevation8FuseTimestamp : 6    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownElevation8FuseTimestamp : 7    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownElevation8FuseTimestamp : 8    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}blownElevation8FuseTimestamp : 9    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank1Fuse : 0    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank1Fuse : 1    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank1Fuse : 2    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank1Fuse : 3    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank1Fuse : 4    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank1Fuse : 5    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank1Fuse : 6    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank1Fuse : 7    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank1Fuse : 8    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank1Fuse : 9    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank1FuseTimestamp : 0    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank1FuseTimestamp : 1    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank1FuseTimestamp : 2    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank1FuseTimestamp : 3    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank1FuseTimestamp : 4    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank1FuseTimestamp : 5    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank1FuseTimestamp : 6    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank1FuseTimestamp : 7    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank1FuseTimestamp : 8    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank1FuseTimestamp : 9    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank2Fuse : 0    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank2Fuse : 1    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank2Fuse : 2    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank2Fuse : 3    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank2Fuse : 4    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank2Fuse : 5    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank2Fuse : 6    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank2Fuse : 7    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank2Fuse : 8    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank2Fuse : 9    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank2FuseTimestamp : 0    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank2FuseTimestamp : 1    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank2FuseTimestamp : 2    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank2FuseTimestamp : 3    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank2FuseTimestamp : 4    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank2FuseTimestamp : 5    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank2FuseTimestamp : 6    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank2FuseTimestamp : 7    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank2FuseTimestamp : 8    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank2FuseTimestamp : 9    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank3Fuse : 0    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank3Fuse : 1    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank3Fuse : 2    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank3Fuse : 3    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank3Fuse : 4    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank3Fuse : 5    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank3Fuse : 6    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank3Fuse : 7    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank3Fuse : 8    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank3Fuse : 9    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank3FuseTimestamp : 0    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank3FuseTimestamp : 1    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank3FuseTimestamp : 2    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank3FuseTimestamp : 3    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank3FuseTimestamp : 4    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank3FuseTimestamp : 5    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank3FuseTimestamp : 6    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank3FuseTimestamp : 7    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank3FuseTimestamp : 8    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank3FuseTimestamp : 9    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank4Fuse : 0    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank4Fuse : 1    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank4Fuse : 2    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank4Fuse : 3    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank4Fuse : 4    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank4Fuse : 5    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank4Fuse : 6    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank4Fuse : 7    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank4Fuse : 8    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank4Fuse : 9    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank4FuseTimestamp : 0    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank4FuseTimestamp : 1    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank4FuseTimestamp : 2    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank4FuseTimestamp : 3    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank4FuseTimestamp : 4    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank4FuseTimestamp : 5    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank4FuseTimestamp : 6    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank4FuseTimestamp : 7    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank4FuseTimestamp : 8    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank4FuseTimestamp : 9    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank5Fuse : 0    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank5Fuse : 1    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank5Fuse : 2    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank5Fuse : 3    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank5Fuse : 4    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank5Fuse : 5    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank5Fuse : 6    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank5Fuse : 7    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank5Fuse : 8    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank5Fuse : 9    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank5FuseTimestamp : 0    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank5FuseTimestamp : 1    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank5FuseTimestamp : 2    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank5FuseTimestamp : 3    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank5FuseTimestamp : 4    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank5FuseTimestamp : 5    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank5FuseTimestamp : 6    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank5FuseTimestamp : 7    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank5FuseTimestamp : 8    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank5FuseTimestamp : 9    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank6Fuse : 0    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank6Fuse : 1    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank6Fuse : 2    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank6Fuse : 3    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank6Fuse : 4    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank6Fuse : 5    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank6Fuse : 6    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank6Fuse : 7    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank6Fuse : 8    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank6Fuse : 9    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank6FuseTimestamp : 0    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank6FuseTimestamp : 1    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank6FuseTimestamp : 2    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank6FuseTimestamp : 3    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank6FuseTimestamp : 4    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank6FuseTimestamp : 5    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank6FuseTimestamp : 6    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank6FuseTimestamp : 7    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank6FuseTimestamp : 8    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank6FuseTimestamp : 9    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank7Fuse : 0    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank7Fuse : 1    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank7Fuse : 2    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank7Fuse : 3    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank7Fuse : 4    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank7Fuse : 5    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank7Fuse : 6    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank7Fuse : 7    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank7Fuse : 8    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank7Fuse : 9    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank7FuseTimestamp : 0    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank7FuseTimestamp : 1    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank7FuseTimestamp : 2    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank7FuseTimestamp : 3    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank7FuseTimestamp : 4    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank7FuseTimestamp : 5    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank7FuseTimestamp : 6    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank7FuseTimestamp : 7    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank7FuseTimestamp : 8    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank7FuseTimestamp : 9    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank8Fuse : 0    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank8Fuse : 1    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank8Fuse : 2    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank8Fuse : 3    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank8Fuse : 4    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank8Fuse : 5    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank8Fuse : 6    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank8Fuse : 7    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank8Fuse : 8    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank8Fuse : 9    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank8FuseTimestamp : 0    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank8FuseTimestamp : 1    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank8FuseTimestamp : 2    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank8FuseTimestamp : 3    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank8FuseTimestamp : 4    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank8FuseTimestamp : 5    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}currentCapacitorBank8FuseTimestamp : 6    1
    ...
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}internalTemperatureCapacitorBank : 3    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}internalTemperatureCapacitorBank : 4    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}internalTemperatureCapacitorBank : 5    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}internalTemperatureCapacitorBank : 6    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}internalTemperatureCapacitorBank : 7    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}internalTemperatureCapacitorBank : 8    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}internalTemperatureCapacitorBank : 9    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}internalTemperatureCapacitorBankTimestamp : 0    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}internalTemperatureCapacitorBankTimestamp : 1    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}internalTemperatureCapacitorBankTimestamp : 2    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}internalTemperatureCapacitorBankTimestamp : 3    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}internalTemperatureCapacitorBankTimestamp : 4    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}internalTemperatureCapacitorBankTimestamp : 5    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}internalTemperatureCapacitorBankTimestamp : 6    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}internalTemperatureCapacitorBankTimestamp : 7    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}internalTemperatureCapacitorBankTimestamp : 8    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}internalTemperatureCapacitorBankTimestamp : 9    1
    Should Contain X Times    ${capacitorBank_list}    ${SPACE}${SPACE}${SPACE}${SPACE}timestamp : 1    10
