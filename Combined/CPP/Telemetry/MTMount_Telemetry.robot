...
Read Subscriber
    ...
    Should Contain X Times    ${lockingPins_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPosition1 : 1    10
    Should Contain X Times    ${lockingPins_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPosition1Timestamp : 1    10
    Should Contain X Times    ${lockingPins_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPosition2 : 1    10
    Should Contain X Times    ${lockingPins_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPosition2Timestamp : 1    10
    Should Contain X Times    ${lockingPins_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentage1 : 1    10
    Should Contain X Times    ${lockingPins_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentage1Timestamp : 1    10
    Should Contain X Times    ${lockingPins_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentage2 : 1    10
    Should Contain X Times    ${lockingPins_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentage2Timestamp : 1    10
    Should Contain X Times    ${lockingPins_list}    ${SPACE}${SPACE}${SPACE}${SPACE}demandPosition1 : 1    10
    Should Contain X Times    ${lockingPins_list}    ${SPACE}${SPACE}${SPACE}${SPACE}demandPosition1Timestamp : 1    10
    Should Contain X Times    ${lockingPins_list}    ${SPACE}${SPACE}${SPACE}${SPACE}demandPosition2 : 1    10
    Should Contain X Times    ${lockingPins_list}    ${SPACE}${SPACE}${SPACE}${SPACE}demandPosition2Timestamp : 1    10
    ...
    Should Contain X Times    ${deployablePlatforms_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPositionPlatform1Section1 : 1    10
    Should Contain X Times    ${deployablePlatforms_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPositionPlatform1Section1Timestamp : 1    10
    Should Contain X Times    ${deployablePlatforms_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPositionPlatform1Section2 : 1    10
    Should Contain X Times    ${deployablePlatforms_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPositionPlatform1Section2Timestamp : 1    10
    Should Contain X Times    ${deployablePlatforms_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPositionPlatform2Section1 : 1    10
    Should Contain X Times    ${deployablePlatforms_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPositionPlatform2Section1Timestamp : 1    10
    Should Contain X Times    ${deployablePlatforms_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPositionPlatform2Section2 : 1    10
    Should Contain X Times    ${deployablePlatforms_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPositionPlatform2Section2Timestamp : 1    10
    Should Contain X Times    ${deployablePlatforms_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentagePlatform1Drive1 : 1    10
    Should Contain X Times    ${deployablePlatforms_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentagePlatform1Drive1Timestamp : 1    10
    Should Contain X Times    ${deployablePlatforms_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentagePlatform1Drive2 : 1    10
    Should Contain X Times    ${deployablePlatforms_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentagePlatform1Drive2Timestamp : 1    10
    Should Contain X Times    ${deployablePlatforms_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentagePlatform2Drive1 : 1    10
    Should Contain X Times    ${deployablePlatforms_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentagePlatform2Drive1Timestamp : 1    10
    Should Contain X Times    ${deployablePlatforms_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentagePlatform2Drive2 : 1    10
    Should Contain X Times    ${deployablePlatforms_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentagePlatform2Drive2Timestamp : 1    10
    ...
    Should Contain X Times    ${azimuthCableWrap_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPositionDrive1 : 1    10
    Should Contain X Times    ${azimuthCableWrap_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPositionDrive1Timestamp : 1    10
    Should Contain X Times    ${azimuthCableWrap_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPositionDrive2 : 1    10
    Should Contain X Times    ${azimuthCableWrap_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPositionDrive2Timestamp : 1    10
    Should Contain X Times    ${azimuthCableWrap_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualVelocityDrive1 : 1    10
    Should Contain X Times    ${azimuthCableWrap_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualVelocityDrive1Timestamp : 1    10
    Should Contain X Times    ${azimuthCableWrap_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualVelocityDrive2 : 1    10
    Should Contain X Times    ${azimuthCableWrap_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualVelocityDrive2Timestamp : 1    10
    ...
    Should Contain X Times    ${cameraCableWrap_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentage1 : 1    10
    Should Contain X Times    ${cameraCableWrap_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentage1Timestamp : 1    10
    Should Contain X Times    ${cameraCableWrap_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentage2 : 1    10
    Should Contain X Times    ${cameraCableWrap_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentage2Timestamp : 1    10
    ...
    Should Contain X Times    ${balancing_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPosition1 : 1    10
    Should Contain X Times    ${balancing_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPosition1Timestamp : 1    10
    Should Contain X Times    ${balancing_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPosition2 : 1    10
    Should Contain X Times    ${balancing_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPosition2Timestamp : 1    10
    Should Contain X Times    ${balancing_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPosition3 : 1    10
    Should Contain X Times    ${balancing_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPosition3Timestamp : 1    10
    Should Contain X Times    ${balancing_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPosition4 : 1    10
    Should Contain X Times    ${balancing_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPosition4Timestamp : 1    10
    Should Contain X Times    ${balancing_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentage1 : 1    10
    Should Contain X Times    ${balancing_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentage1Timestamp : 1    10
    Should Contain X Times    ${balancing_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentage2 : 1    10
    Should Contain X Times    ${balancing_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentage2Timestamp : 1    10
    Should Contain X Times    ${balancing_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentage3 : 1    10
    Should Contain X Times    ${balancing_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentage3Timestamp : 1    10
    Should Contain X Times    ${balancing_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentage4 : 1    10
    Should Contain X Times    ${balancing_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentage4Timestamp : 1    10
    Should Contain X Times    ${balancing_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualVelocity1 : 1    10
    Should Contain X Times    ${balancing_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualVelocity1Timestamp : 1    10
    Should Contain X Times    ${balancing_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualVelocity2 : 1    10
    Should Contain X Times    ${balancing_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualVelocity2Timestamp : 1    10
    Should Contain X Times    ${balancing_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualVelocity3 : 1    10
    Should Contain X Times    ${balancing_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualVelocity3Timestamp : 1    10
    Should Contain X Times    ${balancing_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualVelocity4 : 1    10
    Should Contain X Times    ${balancing_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualVelocity4Timestamp : 1    10
    ...
    Should Contain X Times    ${azimuthDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current1 : 1    10
    Should Contain X Times    ${azimuthDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current10Timestamp : 1    10
    Should Contain X Times    ${azimuthDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current11 : 1    10
    Should Contain X Times    ${azimuthDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current11Timestamp : 1    10
    Should Contain X Times    ${azimuthDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current12 : 1    10
    Should Contain X Times    ${azimuthDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current12Timestamp : 1    10
    Should Contain X Times    ${azimuthDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current13 : 1    10
    Should Contain X Times    ${azimuthDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current13Timestamp : 1    10
    Should Contain X Times    ${azimuthDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current14 : 1    10
    Should Contain X Times    ${azimuthDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current14Timestamp : 1    10
    Should Contain X Times    ${azimuthDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current15 : 1    10
    Should Contain X Times    ${azimuthDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current15Timestamp : 1    10
    Should Contain X Times    ${azimuthDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current16 : 1    10
    Should Contain X Times    ${azimuthDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current16Timestamp : 1    10
    Should Contain X Times    ${azimuthDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current1Timestamp : 1    10
    Should Contain X Times    ${azimuthDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current2 : 1    10
    Should Contain X Times    ${azimuthDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current2Timestamp : 1    10
    Should Contain X Times    ${azimuthDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current3 : 1    10
    Should Contain X Times    ${azimuthDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current3Timestamp : 1    10
    Should Contain X Times    ${azimuthDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current4 : 1    10
    Should Contain X Times    ${azimuthDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current4Timestamp : 1    10
    Should Contain X Times    ${azimuthDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current5 : 1    10
    Should Contain X Times    ${azimuthDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current5Timestamp : 1    10
    Should Contain X Times    ${azimuthDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current6 : 1    10
    Should Contain X Times    ${azimuthDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current6Timestamp : 1    10
    Should Contain X Times    ${azimuthDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current7 : 1    10
    Should Contain X Times    ${azimuthDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current7Timestamp : 1    10
    Should Contain X Times    ${azimuthDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current8 : 1    10
    Should Contain X Times    ${azimuthDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current8Timestamp : 1    10
    Should Contain X Times    ${azimuthDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current9 : 1    10
    Should Contain X Times    ${azimuthDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current9Timestamp : 1    10
    ...
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTemperature1 : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTemperature10Timestamp : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTemperature11 : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTemperature11Timestamp : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTemperature12 : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTemperature12Timestamp : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTemperature13 : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTemperature13Timestamp : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTemperature14 : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTemperature14Timestamp : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTemperature15 : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTemperature15Timestamp : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTemperature16 : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTemperature16Timestamp : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTemperature1Timestamp : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTemperature2 : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTemperature2Timestamp : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTemperature3 : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTemperature3Timestamp : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTemperature4 : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTemperature4Timestamp : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTemperature5 : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTemperature5Timestamp : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTemperature6 : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTemperature6Timestamp : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTemperature7 : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTemperature7Timestamp : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTemperature8 : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTemperature8Timestamp : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTemperature9 : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTemperature9Timestamp : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualValvePositionAzimuth1 : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualValvePositionAzimuth1Timestamp : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualValvePositionAzimuth2 : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualValvePositionAzimuth2Timestamp : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualValvePositionAzimuth3 : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualValvePositionAzimuth3Timestamp : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualValvePositionAzimuth4 : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualValvePositionAzimuth4Timestamp : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}setpointTemperature1 : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}setpointTemperature1Timestamp : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}setpointTemperature2 : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}setpointTemperature2Timestamp : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}setpointTemperature3 : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}setpointTemperature3Timestamp : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}setpointTemperature4 : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}setpointTemperature4Timestamp : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}setpointValvePositionAzimuth1 : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}setpointValvePositionAzimuth1Timestamp : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}setpointValvePositionAzimuth2 : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}setpointValvePositionAzimuth2Timestamp : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}setpointValvePositionAzimuth3 : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}setpointValvePositionAzimuth3Timestamp : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}setpointValvePositionAzimuth4 : 1    10
    Should Contain X Times    ${azimuthDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}setpointValvePositionAzimuth4Timestamp : 1    10
    ...
    Should Contain X Times    ${elevationDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current1 : 1    10
    Should Contain X Times    ${elevationDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current10Timestamp : 1    10
    Should Contain X Times    ${elevationDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current11 : 1    10
    Should Contain X Times    ${elevationDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current11Timestamp : 1    10
    Should Contain X Times    ${elevationDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current12 : 1    10
    Should Contain X Times    ${elevationDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current12Timestamp : 1    10
    Should Contain X Times    ${elevationDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current1Timestamp : 1    10
    Should Contain X Times    ${elevationDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current2 : 1    10
    Should Contain X Times    ${elevationDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current2Timestamp : 1    10
    Should Contain X Times    ${elevationDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current3 : 1    10
    Should Contain X Times    ${elevationDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current3Timestamp : 1    10
    Should Contain X Times    ${elevationDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current4 : 1    10
    Should Contain X Times    ${elevationDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current4Timestamp : 1    10
    Should Contain X Times    ${elevationDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current5 : 1    10
    Should Contain X Times    ${elevationDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current5Timestamp : 1    10
    Should Contain X Times    ${elevationDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current6 : 1    10
    Should Contain X Times    ${elevationDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current6Timestamp : 1    10
    Should Contain X Times    ${elevationDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current7 : 1    10
    Should Contain X Times    ${elevationDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current7Timestamp : 1    10
    Should Contain X Times    ${elevationDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current8 : 1    10
    Should Contain X Times    ${elevationDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current8Timestamp : 1    10
    Should Contain X Times    ${elevationDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current9 : 1    10
    Should Contain X Times    ${elevationDrives_list}    ${SPACE}${SPACE}${SPACE}${SPACE}current9Timestamp : 1    10
    ...
    Should Contain X Times    ${elevationDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualValvePositionElevation1 : 1    10
    Should Contain X Times    ${elevationDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualValvePositionElevation1Timestamp : 1    10
    Should Contain X Times    ${elevationDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualValvePositionElevation2 : 1    10
    Should Contain X Times    ${elevationDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualValvePositionElevation2Timestamp : 1    10
    Should Contain X Times    ${elevationDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}setpointTemperature1 : 1    10
    Should Contain X Times    ${elevationDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}setpointTemperature1Timestamp : 1    10
    Should Contain X Times    ${elevationDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}setpointTemperature2 : 1    10
    Should Contain X Times    ${elevationDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}setpointTemperature2Timestamp : 1    10
    Should Contain X Times    ${elevationDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}setpointValvePositionElevation1 : 1    10
    Should Contain X Times    ${elevationDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}setpointValvePositionElevation1Timestamp : 1    10
    Should Contain X Times    ${elevationDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}setpointValvePositionElevation2 : 1    10
    Should Contain X Times    ${elevationDrivesThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}setpointValvePositionElevation2Timestamp : 1    10
    ...
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}azimuthEncoderAbsolutePosition1 : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}azimuthEncoderAbsolutePosition1Timestamp : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}azimuthEncoderAbsolutePosition2 : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}azimuthEncoderAbsolutePosition2Timestamp : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}azimuthEncoderAbsolutePosition3 : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}azimuthEncoderAbsolutePosition3Timestamp : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}azimuthEncoderAbsolutePosition4 : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}azimuthEncoderAbsolutePosition4Timestamp : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}azimuthEncoderPosition1 : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}azimuthEncoderPosition1Timestamp : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}azimuthEncoderPosition2 : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}azimuthEncoderPosition2Timestamp : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}azimuthEncoderPosition3 : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}azimuthEncoderPosition3Timestamp : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}azimuthEncoderPosition4 : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}azimuthEncoderPosition4Timestamp : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}azimuthEncoderRelativePosition1 : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}azimuthEncoderRelativePosition1Timestamp : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}azimuthEncoderRelativePosition2 : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}azimuthEncoderRelativePosition2Timestamp : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}azimuthEncoderRelativePosition3 : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}azimuthEncoderRelativePosition3Timestamp : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}azimuthEncoderRelativePosition4 : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}azimuthEncoderRelativePosition4Timestamp : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}elevationEncoderAbsolutePosition1 : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}elevationEncoderAbsolutePosition1Timestamp : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}elevationEncoderAbsolutePosition2 : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}elevationEncoderAbsolutePosition2Timestamp : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}elevationEncoderAbsolutePosition3 : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}elevationEncoderAbsolutePosition3Timestamp : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}elevationEncoderAbsolutePosition4 : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}elevationEncoderAbsolutePosition4Timestamp : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}elevationEncoderPosition1 : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}elevationEncoderPosition1Timestamp : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}elevationEncoderPosition2 : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}elevationEncoderPosition2Timestamp : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}elevationEncoderPosition3 : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}elevationEncoderPosition3Timestamp : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}elevationEncoderPosition4 : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}elevationEncoderPosition4Timestamp : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}elevationEncoderRelativePosition1 : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}elevationEncoderRelativePosition1Timestamp : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}elevationEncoderRelativePosition2 : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}elevationEncoderRelativePosition2Timestamp : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}elevationEncoderRelativePosition3 : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}elevationEncoderRelativePosition3Timestamp : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}elevationEncoderRelativePosition4 : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}elevationEncoderRelativePosition4Timestamp : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}encoderHeadReadReferenceAZ1 : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}encoderHeadReadReferenceAZ1Timestamp : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}encoderHeadReadReferenceAZ2 : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}encoderHeadReadReferenceAZ2Timestamp : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}encoderHeadReadReferenceAZ3 : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}encoderHeadReadReferenceAZ3Timestamp : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}encoderHeadReadReferenceAZ4 : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}encoderHeadReadReferenceAZ4Timestamp : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}encoderHeadReadReferenceEL1 : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}encoderHeadReadReferenceEL1Timestamp : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}encoderHeadReadReferenceEL2 : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}encoderHeadReadReferenceEL2Timestamp : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}encoderHeadReadReferenceEL3 : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}encoderHeadReadReferenceEL3Timestamp : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}encoderHeadReadReferenceEL4 : 1    10
    Should Contain X Times    ${encoder_list}    ${SPACE}${SPACE}${SPACE}${SPACE}encoderHeadReadReferenceEL4Timestamp : 1    10
    ...
    Should Contain X Times    ${mainCabinetThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}mainCabinetInternalTemperature1 : 1    10
    Should Contain X Times    ${mainCabinetThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}mainCabinetInternalTemperature1Timestamp : 1    10
    Should Contain X Times    ${mainCabinetThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}mainCabinetInternalTemperature2 : 1    10
    Should Contain X Times    ${mainCabinetThermal_list}    ${SPACE}${SPACE}${SPACE}${SPACE}mainCabinetInternalTemperature2Timestamp : 1    10
    ...
    Should Contain X Times    ${mirrorCoverLocks_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPosition1 : 1    10
    Should Contain X Times    ${mirrorCoverLocks_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPosition1Timestamp : 1    10
    Should Contain X Times    ${mirrorCoverLocks_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPosition2 : 1    10
    Should Contain X Times    ${mirrorCoverLocks_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPosition2Timestamp : 1    10
    Should Contain X Times    ${mirrorCoverLocks_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPosition3 : 1    10
    Should Contain X Times    ${mirrorCoverLocks_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPosition3Timestamp : 1    10
    Should Contain X Times    ${mirrorCoverLocks_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPosition4 : 1    10
    Should Contain X Times    ${mirrorCoverLocks_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPosition4Timestamp : 1    10
    Should Contain X Times    ${mirrorCoverLocks_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentage1 : 1    10
    Should Contain X Times    ${mirrorCoverLocks_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentage1Timestamp : 1    10
    Should Contain X Times    ${mirrorCoverLocks_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentage2 : 1    10
    Should Contain X Times    ${mirrorCoverLocks_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentage2Timestamp : 1    10
    Should Contain X Times    ${mirrorCoverLocks_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentage3 : 1    10
    Should Contain X Times    ${mirrorCoverLocks_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentage3Timestamp : 1    10
    Should Contain X Times    ${mirrorCoverLocks_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentage4 : 1    10
    Should Contain X Times    ${mirrorCoverLocks_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentage4Timestamp : 1    10
    ...
    Should Contain X Times    ${mirrorCover_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPosition1 : 1    10
    Should Contain X Times    ${mirrorCover_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPosition1Timestamp : 1    10
    Should Contain X Times    ${mirrorCover_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPosition2 : 1    10
    Should Contain X Times    ${mirrorCover_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPosition2Timestamp : 1    10
    Should Contain X Times    ${mirrorCover_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPosition3 : 1    10
    Should Contain X Times    ${mirrorCover_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPosition3Timestamp : 1    10
    Should Contain X Times    ${mirrorCover_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPosition4 : 1    10
    Should Contain X Times    ${mirrorCover_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualPosition4Timestamp : 1    10
    Should Contain X Times    ${mirrorCover_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentage1 : 1    10
    Should Contain X Times    ${mirrorCover_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentage1Timestamp : 1    10
    Should Contain X Times    ${mirrorCover_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentage2 : 1    10
    Should Contain X Times    ${mirrorCover_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentage2Timestamp : 1    10
    Should Contain X Times    ${mirrorCover_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentage3 : 1    10
    Should Contain X Times    ${mirrorCover_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentage3Timestamp : 1    10
    Should Contain X Times    ${mirrorCover_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentage4 : 1    10
    Should Contain X Times    ${mirrorCover_list}    ${SPACE}${SPACE}${SPACE}${SPACE}actualTorquePercentage4Timestamp : 1    10
    ...
    Should Contain X Times    ${topEndChiller_list}    ${SPACE}${SPACE}${SPACE}${SPACE}externalTemperatureElectricalCabinet1 : 1    10
    Should Contain X Times    ${topEndChiller_list}    ${SPACE}${SPACE}${SPACE}${SPACE}externalTemperatureElectricalCabinet1Timestamp : 1    10
    Should Contain X Times    ${topEndChiller_list}    ${SPACE}${SPACE}${SPACE}${SPACE}externalTemperatureElectricalCabinet2 : 1    10
    Should Contain X Times    ${topEndChiller_list}    ${SPACE}${SPACE}${SPACE}${SPACE}externalTemperatureElectricalCabinet2Timestamp : 1    10
    Should Contain X Times    ${topEndChiller_list}    ${SPACE}${SPACE}${SPACE}${SPACE}externalTemperatureElectricalCabinet3 : 1    10
    Should Contain X Times    ${topEndChiller_list}    ${SPACE}${SPACE}${SPACE}${SPACE}externalTemperatureElectricalCabinet3Timestamp : 1    10
    Should Contain X Times    ${topEndChiller_list}    ${SPACE}${SPACE}${SPACE}${SPACE}externalTemperatureElectricalCabinet4 : 1    10
    Should Contain X Times    ${topEndChiller_list}    ${SPACE}${SPACE}${SPACE}${SPACE}externalTemperatureElectricalCabinet4Timestamp : 1    10
    ...
    Should Contain X Times    ${topEndChiller_list}    ${SPACE}${SPACE}${SPACE}${SPACE}internalTemperatureElectricalCabinet1 : 1    10
    Should Contain X Times    ${topEndChiller_list}    ${SPACE}${SPACE}${SPACE}${SPACE}internalTemperatureElectricalCabinet1Timestamp : 1    10
    Should Contain X Times    ${topEndChiller_list}    ${SPACE}${SPACE}${SPACE}${SPACE}internalTemperatureElectricalCabinet2 : 1    10
    Should Contain X Times    ${topEndChiller_list}    ${SPACE}${SPACE}${SPACE}${SPACE}internalTemperatureElectricalCabinet2Timestamp : 1    10
    Should Contain X Times    ${topEndChiller_list}    ${SPACE}${SPACE}${SPACE}${SPACE}internalTemperatureElectricalCabinet3 : 1    10
    Should Contain X Times    ${topEndChiller_list}    ${SPACE}${SPACE}${SPACE}${SPACE}internalTemperatureElectricalCabinet3Timestamp : 1    10
    Should Contain X Times    ${topEndChiller_list}    ${SPACE}${SPACE}${SPACE}${SPACE}internalTemperatureElectricalCabinet4 : 1    10
    Should Contain X Times    ${topEndChiller_list}    ${SPACE}${SPACE}${SPACE}${SPACE}internalTemperatureElectricalCabinet4Timestamp : 1    10
