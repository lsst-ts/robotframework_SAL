...
Start Publisher
    ...
    Should Contain    ${output.stdout}    === ATPtg_prospectiveTargetStatus start of topic ===
    ...
    Should Contain    ${output.stdout}    === ATPtg_prospectiveTargetStatus end of topic ===
    ...
    @{words}=    Split String    ${line}
    ${revcode}=    Set Variable    @{words}[2]
    Should Contain    ${output.stdout}    === ATPtg_nextTargetStatus start of topic ===
    Should Contain X Times    ${output.stdout}    [putSample] ${subSystem}::nextTargetStatus_${revcode} writing a message containing :    10
    Should Contain X Times    ${output.stdout}    revCode \ : ${revcode}    10
    Should Contain    ${output.stdout}    === ATPtg_nextTargetStatus end of topic ===
    ...
    @{words}=    Split String    ${line}
    ${revcode}=    Set Variable    @{words}[2]
    Should Contain    ${output.stdout}    === ATPtg_prospectiveTimesToLimits start of topic ===
    ...
    Should Contain X Times    ${output.stdout}    revCode \ : ${revcode}    10
    Should Contain    ${output.stdout}    === ATPtg_prospectiveTimesToLimits end of topic ===
    ...
    @{words}=    Split String    ${line}
    ${revcode}=    Set Variable    @{words}[2]
    Should Contain    ${output.stdout}    === ATPtg_nextTimesToLimits start of topic ===
