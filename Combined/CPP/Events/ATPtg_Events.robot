...
Read Logger
    ...
    ${end}=    Evaluate    ${focusNameSelected_start}+${3}
    ...
    ${end}=    Evaluate    ${sunProximityWarning_start}+${3}
    ...
    ${end}=    Evaluate    ${azWrapWarning_start}+${3}
    ...
    ${end}=    Evaluate    ${wavelength_start}+${3}
    ...
    ${end}=    Evaluate    ${objectSetWarning_start}+${3}
    ...
    ${end}=    Evaluate    ${pointingModel_start}+${5}
    ...
    ${end}=    Evaluate    ${airmassWarning_start}+${3}
    ...
    ${end}=    Evaluate    ${weatherDataInvalid_start}+${3}
    ...
    ${end}=    Evaluate    ${focusNameInconsistentWarning_start}+${3}
    ...
    ${end}=    Evaluate    ${currentTarget_start}+${29}
    ...
    ${end}=    Evaluate    ${iersOutOfDate_start}+${3}
    ...
    ${end}=    Evaluate    ${weatherDataApplied_start}+${5}
    ...
    ${end}=    Evaluate    ${currentDebugLevel_start}+${3}
    ...
    ${end}=    Evaluate    ${mountDataWarning_start}+${3}
    ...
    ${end}=    Evaluate    ${rotWrapWarning_start}+${3}
    ...
    ${end}=    Evaluate    ${moonProximityWarning_start}+${3}
    ...
    ${end}=    Evaluate    ${trackPosting_start}+${3}
    ...
    ${end}=    Evaluate    ${ptgAzCurrentWrap_start}+${3}
    ...
    ${end}=    Evaluate    ${ptgRotCurrentWrap_start}+${3}
    ...
    ${end}=    Evaluate    ${elLimitWarning_start}+${3}
    ...
    ${end}=    Evaluate    ${pointingFile_start}+${4}
    ...
    ${end}=    Evaluate    ${timesOfLimits_start}+${9}
    ...
    ${end}=    Evaluate    ${validatedTarget_start}+${7}
    ...
    ${end}=    Evaluate    ${offsetSummary_start}+${18}
    ...
    ${end}=    Evaluate    ${pointData_start}+${8}
    ...
    ${end}=    Evaluate    ${observatoryLocation_start}+${6}
