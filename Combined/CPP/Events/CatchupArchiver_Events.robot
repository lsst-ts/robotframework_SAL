...
Start Sender
    ...
    Should Contain    ${output.stdout}    === ${subSystem}_catchuparchiverEntityStartup end of topic ===
    ...
    Should Contain    ${output.stdout}    revCode \ : ${revcode}    10
    Should Contain    ${output.stdout}    === ${subSystem}_catchuparchiverEntitySummaryState end of topic ===
    ...
    Should Contain    ${output.stdout}    revCode \ : ${revcode}    10
    Should Contain    ${output.stdout}    === ${subSystem}_catchuparchiverEntityShutdown end of topic ===
...
Read Logger
    ...
    ${catchuparchiverEntitySummaryState_start}=    Get Index From List    ${full_list}    === ${subSystem}_catchuparchiverEntitySummaryState start of topic ===
    ${catchuparchiverEntitySummaryState_end}=    Get Index From List    ${full_list}    === ${subSystem}_catchuparchiverEntitySummaryState end of topic ===
    ...
    ${catchuparchiverEntityShutdown_start}=    Get Index From List    ${full_list}    === ${subSystem}_catchuparchiverEntityShutdown start of topic ===
    ${catchuparchiverEntityShutdown_end}=    Get Index From List    ${full_list}    === ${subSystem}_catchuparchiverEntityShutdown end of topic ===
