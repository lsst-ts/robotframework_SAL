...
Read Logger
    ...
    ${acquisitionRate_start}=    Get Index From List    ${full_list}    === ${subSystem}_acquisitionRate start of topic ===
    ${acquisitionRate_end}=    Get Index From List    ${full_list}    === ${subSystem}_acquisitionRate end of topic ===
