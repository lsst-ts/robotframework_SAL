...
Read Logger
    ...
    ${m2AssemblyInPosition_start}=    Get Index From List    ${full_list}    === ${subSystem}_m2AssemblyInPosition start of topic ===
    ${m2AssemblyInPosition_end}=    Get Index From List    ${full_list}    === ${subSystem}_m2AssemblyInPosition end of topic ===
