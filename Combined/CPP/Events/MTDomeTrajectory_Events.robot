...
Start Sender
    ...
    Should Contain    ${output.stdout}    revCode \ : ${revcode}    10
    Should Contain    ${output.stdout}    === ${subSystem}_allClear end of topic ===
...
Read Logger
    ...
    ${allClear_start}=    Get Index From List    ${full_list}    === ${subSystem}_allClear start of topic ===
    ${allClear_end}=    Get Index From List    ${full_list}    === ${subSystem}_allClear end of topic ===
