...
Read Logger
    ...
    ${processingStatus_start}=    Get Index From List    ${full_list}    === ${subSystem}_processingStatus start of topic ===
    ${processingStatus_end}=    Get Index From List    ${full_list}    === ${subSystem}_processingStatus end of topic ===
