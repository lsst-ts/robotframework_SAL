...
Start Sender
    ...
    Should Contain    ${output.stdout}    revCode \ : ${revcode}    10
    Should Contain    ${output.stdout}    === ${subSystem}_scalars end of topic ===
    ...
    Should Contain    ${output.stdout}    revCode \ : ${revcode}    10
    Should Contain    ${output.stdout}    === ${subSystem}_arrays end of topic ===
...
Read Logger
    ...
    ${scalars_start}=    Get Index From List    ${full_list}    === ${subSystem}_scalars start of topic ===
    ${scalars_end}=    Get Index From List    ${full_list}    === ${subSystem}_scalars end of topic ===
    ...
    ${arrays_start}=    Get Index From List    ${full_list}    === ${subSystem}_arrays start of topic ===
    ${arrays_end}=    Get Index From List    ${full_list}    === ${subSystem}_arrays end of topic ===
    ...
    Should Contain X Times    ${arrays_list}    ${SPACE}${SPACE}${SPACE}${SPACE}char0 : LSST    1
