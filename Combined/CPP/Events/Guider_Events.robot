...
Read Logger
    ...
    ${end}=    Get Index From List    ${full_list}    ${SPACE}${SPACE}${SPACE}${SPACE}priority : 1    start=${guidingStatus_start}
    ${guidingStatus_end}=    Evaluate    ${end}+${1}
    ${guidingStatus_list}=    Get Slice From List    ${full_list}    start=${guidingStatus_start}    end=${guidingStatus_end}
    ...
    Should Contain X Times    ${guidingStatus_list}    ${SPACE}${SPACE}${SPACE}${SPACE}priority : 1    1
