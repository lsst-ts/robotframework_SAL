...
Read Logger
    ...
    ${mtArchiverEntityShutdown_start}=    Get Index From List    ${full_list}    === ${subSystem}_mtArchiverEntityShutdown start of topic ===
    ${mtArchiverEntityShutdown_end}=    Get Index From List    ${full_list}    === ${subSystem}_mtArchiverEntityShutdown end of topic ===
    ...
    ${mtArchiverEntityStartup_start}=    Get Index From List    ${full_list}    === ${subSystem}_mtArchiverEntityStartup start of topic ===
    ${mtArchiverEntityStartup_end}=    Get Index From List    ${full_list}    === ${subSystem}_mtArchiverEntityStartup end of topic ===
    ...
    ${mtArchiverEntitySummaryState_start}=    Get Index From List    ${full_list}    === ${subSystem}_mtArchiverEntitySummaryState start of topic ===
    ${mtArchiverEntitySummaryState_end}=    Get Index From List    ${full_list}    === ${subSystem}_mtArchiverEntitySummaryState end of topic ===
