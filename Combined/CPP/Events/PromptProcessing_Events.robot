...
Start Sender
    ...
    Should Contain    ${output.stdout}    === ${subSystem}_entitySummaryState end of topic ===
    ...
    Should Contain    ${output.stdout}    revCode \ : ${revcode}    10
    Should Contain    ${output.stdout}    === ${subSystem}_entityStartup end of topic ===
    ...
    Should Contain    ${output.stdout}    revCode \ : ${revcode}    10
    Should Contain    ${output.stdout}    === ${subSystem}_entityShutdown end of topic ===
...
Read Logger
    ...
    ${entitySummaryState_start}=    Get Index From List    ${full_list}    === ${subSystem}_entitySummaryState start of topic ===
    ${entitySummaryState_end}=    Get Index From List    ${full_list}    === ${subSystem}_entitySummaryState end of topic ===
    ...
    ${entityStartup_start}=    Get Index From List    ${full_list}    === ${subSystem}_entityStartup start of topic ===
    ${entityStartup_end}=    Get Index From List    ${full_list}    === ${subSystem}_entityStartup end of topic ===
    ...
    ${entityShutdown_start}=    Get Index From List    ${full_list}    === ${subSystem}_entityShutdown start of topic ===
    ${entityShutdown_end}=    Get Index From List    ${full_list}    === ${subSystem}_entityShutdown end of topic ===
