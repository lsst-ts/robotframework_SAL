...
Read Logger
    ...
    Should Contain X Times    ${hardpointMonitorWarning_list}    ${SPACE}${SPACE}${SPACE}${SPACE}anyApplicationCRCMismatch : 0    1
    ...
    ${end}=    Evaluate    ${forceActuatorBumpTestStatus_start}+${8}
    ...
    ${end}=    Evaluate    ${forceActuatorSettings_start}+${47}
    ...
    ${end}=    Evaluate    ${hardpointActuatorSettings_start}+${20}
