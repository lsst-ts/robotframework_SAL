...
Start Publisher
    ...
    ${focal_plane_RebsAverageTemp6_start}=    Get Index From List    ${full_list}    === CCCamera_focal_plane_RebsAverageTemp6 start of topic ===
    ${focal_plane_RebsAverageTemp6_end}=    Get Index From List    ${full_list}    === CCCamera_focal_plane_RebsAverageTemp6 end of topic ===
    ...
    Should Contain    ${focal_plane_RebsAverageTemp6_list}    === CCCamera_focal_plane_RebsAverageTemp6 start of topic ===
    Should Contain    ${focal_plane_RebsAverageTemp6_list}    === CCCamera_focal_plane_RebsAverageTemp6 end of topic ===
