...
Start Sender
    ...
    Should Contain    ${settingVersions_list}    === GCHeaderService_settingVersions start of topic ===
    Should Contain    ${settingVersions_list}    === GCHeaderService_settingVersions end of topic ===
    ...
    ${appliedSettingsMatchStart_start}=    Get Index From List    ${full_list}    === GCHeaderService_appliedSettingsMatchStart start of topic ===
    ${appliedSettingsMatchStart_end}=    Get Index From List    ${full_list}    === GCHeaderService_appliedSettingsMatchStart end of topic ===
    ...
    Should Contain    ${appliedSettingsMatchStart_list}    === GCHeaderService_appliedSettingsMatchStart start of topic ===
    Should Contain    ${appliedSettingsMatchStart_list}    === GCHeaderService_appliedSettingsMatchStart end of topic ===
    ...
    ${settingsApplied_start}=    Get Index From List    ${full_list}    === GCHeaderService_settingsApplied start of topic ===
    ${settingsApplied_end}=    Get Index From List    ${full_list}    === GCHeaderService_settingsApplied end of topic ===
    ...
    Should Contain    ${settingsApplied_list}    === GCHeaderService_settingsApplied start of topic ===
    Should Contain    ${settingsApplied_list}    === GCHeaderService_settingsApplied end of topic ===
