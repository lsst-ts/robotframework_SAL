...
Start Sender
    ...
    ${settingVersions_start}=    Get Index From List    ${full_list}    === MTHeaderService_settingVersions start of topic ===
    ${settingVersions_end}=    Get Index From List    ${full_list}    === MTHeaderService_settingVersions end of topic ===
    ...
    Should Contain    ${settingVersions_list}    === MTHeaderService_settingVersions start of topic ===
    Should Contain    ${settingVersions_list}    === MTHeaderService_settingVersions end of topic ===
    ...
    ${appliedSettingsMatchStart_start}=    Get Index From List    ${full_list}    === MTHeaderService_appliedSettingsMatchStart start of topic ===
    ${appliedSettingsMatchStart_end}=    Get Index From List    ${full_list}    === MTHeaderService_appliedSettingsMatchStart end of topic ===
    ...
    Should Contain    ${appliedSettingsMatchStart_list}    === MTHeaderService_appliedSettingsMatchStart start of topic ===
    Should Contain    ${appliedSettingsMatchStart_list}    === MTHeaderService_appliedSettingsMatchStart end of topic ===
    ...
    ${settingsApplied_start}=    Get Index From List    ${full_list}    === MTHeaderService_settingsApplied start of topic ===
    ${settingsApplied_end}=    Get Index From List    ${full_list}    === MTHeaderService_settingsApplied end of topic ===
    ...
    Should Contain    ${settingsApplied_list}    === MTHeaderService_settingsApplied start of topic ===
    Should Contain    ${settingsApplied_list}    === MTHeaderService_settingsApplied end of topic ===
    ...
    ${authList_start}=    Get Index From List    ${full_list}    === MTHeaderService_authList start of topic ===
    ${authList_end}=    Get Index From List    ${full_list}    === MTHeaderService_authList end of topic ===
    ${authList_list}=    Get Slice From List    ${full_list}    start=${authList_start}    end=${authList_end + 1}
    Log Many    ${authList_list}
    Should Contain    ${authList_list}    === MTHeaderService_authList start of topic ===
    Should Contain    ${authList_list}    === MTHeaderService_authList end of topic ===
