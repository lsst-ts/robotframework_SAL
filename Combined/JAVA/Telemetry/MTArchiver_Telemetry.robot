*** Settings ***
Documentation    MTArchiver_Telemetry communications tests.
Force Tags    java    
...
Read Subscriber
    ...
    Should Contain    ${output.stdout}    ===== MTArchiver all subscribers ready =====
    ...
    Should Contain    ${sequencerHeartbeat_list}    === MTArchiver_sequencerHeartbeat start of topic ===
    Should Contain    ${sequencerHeartbeat_list}    === MTArchiver_sequencerHeartbeat end of topic ===
