...
Start Publisher
    ...
    Should Contain    ${fcs_list}    === [putSample fcs] writing a message containing :
    ...
    Should Contain    ${bonn_shutter_Device_list}    === [putSample bonn_shutter_Device] writing a message containing :
...
Read Subscriber
    ...
    Should Contain    ${fcs_list}    === CCCamera_fcs start of topic ===
    Should Contain    ${fcs_list}    === CCCamera_fcs end of topic ===
    Should Contain    ${fcs_list}    === [getSample fcs ] message received :0
    ...
    Should Contain    ${bonn_shutter_Device_list}    === CCCamera_bonn_shutter_Device start of topic ===
    Should Contain    ${bonn_shutter_Device_list}    === CCCamera_bonn_shutter_Device end of topic ===
    Should Contain    ${bonn_shutter_Device_list}    === [getSample bonn_shutter_Device ] message received :0
