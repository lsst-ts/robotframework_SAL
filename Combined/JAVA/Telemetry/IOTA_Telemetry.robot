*** Settings ***
Documentation    IOTA_Telemetry communications tests.
Force Tags    java    
...
Read Subscriber
    ...
    Log Many    ${output.stdout}    ${output.stderr}
    Should Contain    ${output.stdout}    ===== IOTA all subscribers ready =====
    ...
    Should Contain    ${timestamp_list}    === IOTA_timestamp start of topic ===
    Should Contain    ${timestamp_list}    === IOTA_timestamp end of topic ===
    ...
    Should Contain    ${loopTime_list}    === IOTA_loopTime start of topic ===
    Should Contain    ${loopTime_list}    === IOTA_loopTime end of topic ===
