*** Settings ***
Documentation    PromptProcessing_Telemetry communications tests.
...
Read Subscriber
    ...
    Log Many    ${output.stdout}    ${output.stderr}
    Should Contain    ${output.stdout}    ===== PromptProcessing all subscribers ready =====
    ...
    Should Contain    ${sequencerHeartbeat_list}    === PromptProcessing_sequencerHeartbeat start of topic ===
    Should Contain    ${sequencerHeartbeat_list}    === PromptProcessing_sequencerHeartbeat end of topic ===
