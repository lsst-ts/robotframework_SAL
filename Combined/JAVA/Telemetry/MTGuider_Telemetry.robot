*** Settings ***
Documentation    MTGuider_Telemetry communications tests.
Force Tags    java    
...
Read Subscriber
    ...
    Should Contain    ${output.stdout}    ===== MTGuider all subscribers ready =====
    ...
    Should Contain    ${timestamp_list}    === MTGuider_timestamp start of topic ===
    Should Contain    ${timestamp_list}    === MTGuider_timestamp end of topic ===
    ...
    Should Contain    ${loopTime_list}    === MTGuider_loopTime start of topic ===
    Should Contain    ${loopTime_list}    === MTGuider_loopTime end of topic ===
