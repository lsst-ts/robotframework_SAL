*** Settings ***
Documentation    ATHexapod_Telemetry communications tests.
Force Tags    java    
...
Read Subscriber
    ...
    Log Many    ${positionStatus_list}
    Should Contain    ${positionStatus_list}    === ATHexapod_positionStatus start of topic ===
    Should Contain    ${positionStatus_list}    === ATHexapod_positionStatus end of topic ===
