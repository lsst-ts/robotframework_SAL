*** Settings ***
Documentation    ATMonochromator_Telemetry communications tests.
Force Tags    java    
...
Read Subscriber
    ...
    Should Contain    ${output.stdout}    ===== ATMonochromator all subscribers ready =====
    ...
    Should Contain    ${timestamp_list}    === ATMonochromator_timestamp start of topic ===
    Should Contain    ${timestamp_list}    === ATMonochromator_timestamp end of topic ===
    ...
    Should Contain    ${loopTime_list}    === ATMonochromator_loopTime start of topic ===
    Should Contain    ${loopTime_list}    === ATMonochromator_loopTime end of topic ===
