*** Settings ***
Documentation    WeatherStation_Telemetry communications tests.
...
Read Subscriber
    ...
    Log Many    ${output.stdout}    ${output.stderr}
    Should Contain    ${output.stdout}    ===== WeatherStation all subscribers ready =====
    ...
    Should Contain    ${weather_list}    === WeatherStation_weather start of topic ===
    Should Contain    ${weather_list}    === WeatherStation_weather end of topic ===
    ...
    Should Contain    ${windDirection_list}    === WeatherStation_windDirection start of topic ===
    Should Contain    ${windDirection_list}    === WeatherStation_windDirection end of topic ===
    ...
    Should Contain    ${windGustDirection_list}    === WeatherStation_windGustDirection start of topic ===
    Should Contain    ${windGustDirection_list}    === WeatherStation_windGustDirection end of topic ===
    ...
    Should Contain    ${windSpeed_list}    === WeatherStation_windSpeed start of topic ===
    Should Contain    ${windSpeed_list}    === WeatherStation_windSpeed end of topic ===
    ...
    Should Contain    ${airTemperature_list}    === WeatherStation_airTemperature start of topic ===
    Should Contain    ${airTemperature_list}    === WeatherStation_airTemperature end of topic ===
    ...
    Should Contain    ${relativeHumidity_list}    === WeatherStation_relativeHumidity start of topic ===
    Should Contain    ${relativeHumidity_list}    === WeatherStation_relativeHumidity end of topic ===
    ...
    Should Contain    ${dewPoint_list}    === WeatherStation_dewPoint start of topic ===
    Should Contain    ${dewPoint_list}    === WeatherStation_dewPoint end of topic ===
    ...
    Should Contain    ${snowDepth_list}    === WeatherStation_snowDepth start of topic ===
    Should Contain    ${snowDepth_list}    === WeatherStation_snowDepth end of topic ===
    ...
    Should Contain    ${solarNetRadiation_list}    === WeatherStation_solarNetRadiation start of topic ===
    Should Contain    ${solarNetRadiation_list}    === WeatherStation_solarNetRadiation end of topic ===
    ...
    Should Contain    ${airPressure_list}    === WeatherStation_airPressure start of topic ===
    Should Contain    ${airPressure_list}    === WeatherStation_airPressure end of topic ===
    ...
    Should Contain    ${precipitation_list}    === WeatherStation_precipitation start of topic ===
    Should Contain    ${precipitation_list}    === WeatherStation_precipitation end of topic ===
    ...
    Should Contain    ${soilTemperature_list}    === WeatherStation_soilTemperature start of topic ===
    Should Contain    ${soilTemperature_list}    === WeatherStation_soilTemperature end of topic ===
