*** Settings ***
Documentation    CatchupArchiver_Telemetry communications tests.
Force Tags    java    
...
Read Subscriber
    ...
    Should Contain    ${sequencerHeartbeat_list}    === CatchupArchiver_sequencerHeartbeat start of topic ===
    Should Contain    ${sequencerHeartbeat_list}    === CatchupArchiver_sequencerHeartbeat end of topic ===
