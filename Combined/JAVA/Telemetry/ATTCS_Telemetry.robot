*** Settings ***
Documentation    ATTCS_Telemetry communications tests.
Force Tags    java    
...
Read Subscriber
    ...
    Should Contain    ${output.stdout}    ===== ATTCS all subscribers ready =====
    ...
    Should Contain    ${loopTime_list}    === ATTCS_loopTime start of topic ===
    Should Contain    ${loopTime_list}    === ATTCS_loopTime end of topic ===
    ...
    Should Contain    ${timestamp_list}    === ATTCS_timestamp start of topic ===
    Should Contain    ${timestamp_list}    === ATTCS_timestamp end of topic ===
