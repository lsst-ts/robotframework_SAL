*** Settings ***
Documentation    LinearStage_Telemetry communications tests.
Force Tags    java    
...
Read Subscriber
    ...
    Log Many    ${output.stdout}    ${output.stderr}
    Should Contain    ${output.stdout}    ===== LinearStage all subscribers ready =====
    ...
    Should Contain    ${position_list}    === LinearStage_position start of topic ===
    Should Contain    ${position_list}    === LinearStage_position end of topic ===
