*** Settings ***
Documentation    EAS_Telemetry communications tests.
Force Tags    java    
...
Read Subscriber
    ...
    Should Contain    ${output.stdout}    ===== EAS all subscribers ready =====
    ...
    Should Contain    ${timestamp_list}    === EAS_timestamp start of topic ===
    Should Contain    ${timestamp_list}    === EAS_timestamp end of topic ===
    ...
    Should Contain    ${loopTime_list}    === EAS_loopTime start of topic ===
    Should Contain    ${loopTime_list}    === EAS_loopTime end of topic ===
