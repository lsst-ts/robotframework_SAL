*** Settings ***
Documentation    DIMM Status communications tests.
Force Tags    cpp    
...
Read Subscriber
    ...
    Should Contain X Times    ${list}    ${SPACE}${SPACE}${SPACE}${SPACE}status : 1    10
    Should Contain X Times    ${list}    ${SPACE}${SPACE}${SPACE}${SPACE}hrNum : 1    10
