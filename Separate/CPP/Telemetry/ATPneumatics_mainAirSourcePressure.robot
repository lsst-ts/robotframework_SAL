*** Settings ***
Documentation    ATPneumatics MainAirSourcePressure communications tests.
Force Tags    cpp    
...
${component}    mainAirSourcePressure
${timeout}    30s
...
Start Subscriber
    ...
    Should Contain    ${string}    ===== ATPneumatics subscribers ready =====
