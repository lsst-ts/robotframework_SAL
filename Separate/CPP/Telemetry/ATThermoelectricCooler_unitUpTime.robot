*** Settings ***
Documentation    ATThermoelectricCooler UnitUpTime communications tests.
Force Tags    cpp    
...
Start Subscriber
    ...
    Should Contain    ${output}    ===== ATThermoelectricCooler subscribers ready =====
    Sleep    6s
