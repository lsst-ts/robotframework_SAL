*** Settings ***
Documentation    FiberSpectrograph SpectTemperature communications tests.
Force Tags    cpp    
...
Start Subscriber
    ...
    Should Contain    ${string}    ===== FiberSpectrograph subscribers ready =====
