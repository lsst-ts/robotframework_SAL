*** Settings ***
Documentation    Script AuthList tests.
...
*** Test Cases ***
Verify Script AuthList test files
    [Tags]    smoke
...
Execute Script AuthList test script
    [Tags]    functional
...
Verify First AuthList Test
    ...
    Should Contain X Times    ${test_output}    ${SPACE}${SPACE}${SPACE}${SPACE}identity${SPACE}${SPACE}${SPACE}${SPACE}: ${subSystem}:1    3
