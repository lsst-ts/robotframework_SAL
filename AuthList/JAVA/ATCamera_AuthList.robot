*** Settings ***
Documentation    ATCamera AuthList tests.
...
*** Test Cases ***
Verify ATCamera AuthList test files
    [Tags]    smoke
...
Execute ATCamera AuthList test script
    [Tags]    functional
...
Verify First AuthList Test
    ...
    Should Contain X Times    ${test_output}    ${SPACE}${SPACE}${SPACE}${SPACE}identity : ATCamera    3
