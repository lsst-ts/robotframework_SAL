*** Settings ***
Documentation    MTHeaderService AuthList tests.
...
*** Test Cases ***
Verify MTHeaderService AuthList test files
    [Tags]    smoke
...
Execute MTHeaderService AuthList test script
    [Tags]    functional
...
Verify First AuthList Test
    ...
    Should Contain X Times    ${test_output}    ${SPACE}${SPACE}${SPACE}${SPACE}identity : MTHeaderService    3
