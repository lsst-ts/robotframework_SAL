*** Settings ***
Documentation    CCCamera AuthList tests.
...
*** Test Cases ***
Verify CCCamera AuthList test files
    [Tags]    smoke
...
Execute CCCamera AuthList test script
    [Tags]    functional
...
Verify First AuthList Test
    ...
    Should Contain X Times    ${test_output}    ${SPACE}${SPACE}${SPACE}${SPACE}identity : CCCamera    3
