*** Settings ***
Documentation    CCHeaderService AuthList tests.
...
*** Test Cases ***
Verify CCHeaderService AuthList test files
    [Tags]    smoke
...
Execute CCHeaderService AuthList test script
    [Tags]    functional
...
Verify First AuthList Test
    ...
    Should Contain X Times    ${test_output}    ${SPACE}${SPACE}${SPACE}${SPACE}identity : CCHeaderService    3
