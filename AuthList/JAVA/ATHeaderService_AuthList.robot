*** Settings ***
Documentation    ATHeaderService AuthList tests.
...
*** Test Cases ***
Verify ATHeaderService AuthList test files
    [Tags]    smoke
...
Execute ATHeaderService AuthList test script
    [Tags]    functional
...
Verify First AuthList Test
    ...
    Should Contain X Times    ${test_output}    ${SPACE}${SPACE}${SPACE}${SPACE}identity : ATHeaderService    3
