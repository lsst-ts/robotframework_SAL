*** Settings ***
Documentation    GCHeaderService AuthList tests.
...
*** Test Cases ***
Verify GCHeaderService AuthList test files
    [Tags]    smoke
...
Execute GCHeaderService AuthList test script
    [Tags]    functional
...
Verify First AuthList Test
    ...
    Should Contain X Times    ${test_output}    ${SPACE}${SPACE}${SPACE}${SPACE}identity : GCHeaderService:1    3
